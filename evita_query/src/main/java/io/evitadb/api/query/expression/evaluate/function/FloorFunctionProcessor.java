...
/**
 * Function processor for the `floor` function that computes the floor value
 * (largest integer less than or equal to) of a single numeric argument.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2026
 */
public class FloorFunctionProcessor extends AbstractMathFunctionProcessor {
