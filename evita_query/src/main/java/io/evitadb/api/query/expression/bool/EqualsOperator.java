...
public class EqualsOperator extends AbstractBinaryOperator implements BooleanOperator {
	...
	public BigDecimalNumberRange determinePossibleRange() throws UnsupportedDataTypeException {
		final BigDecimalNumberRange range1 = getLeftOperand().determinePossibleRange();
		final BigDecimalNumberRange range2 = getRightOperand().determinePossibleRange();
