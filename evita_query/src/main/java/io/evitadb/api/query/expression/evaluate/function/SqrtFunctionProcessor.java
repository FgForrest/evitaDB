...
/**
 * Function processor for the `sqrt` function that computes the square root
 * of a single numeric argument.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2026
 */
public class SqrtFunctionProcessor extends AbstractMathFunctionProcessor {
	...
	public Serializable process(@Nonnull List<Serializable> arguments) throws ExpressionEvaluationException {
		...
		return number.sqrt(MathContext.DECIMAL64);
	}
