...
abstract sealed class AbstractExpressionEvaluationContext implements ExpressionEvaluationContext
	...
	protected AbstractExpressionEvaluationContext(@Nullable Object thisObject) {
		this.thisObject = thisObject;
		this.random = new Random();
	}

	protected AbstractExpressionEvaluationContext(@Nullable Object thisObject, long seed) {
		this.thisObject = thisObject;
		this.random = new Random(seed);
	}

	protected AbstractExpressionEvaluationContext(@Nullable Object thisObject, @Nonnull Random random) {
		this.thisObject = thisObject;
		this.random = random;
	}
