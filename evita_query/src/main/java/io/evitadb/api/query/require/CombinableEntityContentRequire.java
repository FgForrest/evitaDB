 ...
 */
public interface CombinableEntityContentRequire extends EntityContentRequire {
	 ...
	 */
	@Nonnull
	<T extends CombinableEntityContentRequire> T combineWith(@Nonnull T anotherRequirement);
