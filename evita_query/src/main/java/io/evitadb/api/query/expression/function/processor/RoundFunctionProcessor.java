...
/**
 * Function processor for the `round` function that rounds a numeric argument
 * to the nearest integer using half-up rounding mode.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2026
 */
public class RoundFunctionProcessor extends AbstractMathFunctionProcessor {
