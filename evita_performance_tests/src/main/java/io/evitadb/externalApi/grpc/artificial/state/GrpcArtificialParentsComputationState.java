...
/**
 * Base state class for {@link io.evitadb.externalApi.grpc.artificial.GrpcArtificialEntitiesBenchmark#parentsComputation(GrpcArtificialHierarchyBenchmarkState, GrpcArtificialParentsComputationState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class GrpcArtificialParentsComputationState extends AbstractGrpcArtificialState implements RandomQueryGenerator {
