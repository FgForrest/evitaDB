...
/**
 * Base state class for {@link io.evitadb.externalApi.grpc.artificial.GrpcArtificialEntitiesBenchmark#facetFilteringAndSummarizingCount(GrpcArtificialFacetBenchmarkState, GrpcArtificialFacetFilteringAndSummarizingCountState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class GrpcArtificialFacetFilteringAndSummarizingCountState extends AbstractGrpcArtificialState implements RandomQueryGenerator {
	...
	public void prepareCall(GrpcArtificialFacetBenchmarkState benchmarkState) {
		setQuery(generateRandomFacetSummaryQuery(
