...
/**
 * Base state class for {@link io.evitadb.externalApi.grpc.artificial.GrpcArtificialEntitiesBenchmark#singleEntityRead(GrpcArtificialFullDatabaseBenchmarkState, GrpcArtificialSingleReadState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */

public class GrpcArtificialSingleReadState extends AbstractGrpcArtificialState {
