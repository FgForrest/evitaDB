...
/**
 * Base state class for {@link io.evitadb.externalApi.grpc.artificial.GrpcArtificialEntitiesBenchmark#facetAndHierarchyFiltering(GrpcArtificialFacetBenchmarkState, GrpcArtificialFacetAndHierarchyFilteringState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
@State(Scope.Thread)
public class GrpcArtificialFacetAndHierarchyFilteringState extends AbstractGrpcArtificialState implements RandomQueryGenerator {
