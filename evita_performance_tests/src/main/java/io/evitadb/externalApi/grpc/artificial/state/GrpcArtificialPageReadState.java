...
/**
 * Base state class for {@link io.evitadb.externalApi.grpc.artificial.GrpcArtificialEntitiesBenchmark#paginatedEntityRead(GrpcArtificialFullDatabaseBenchmarkState, GrpcArtificialPageReadState, Blackhole)}.
