...
/**
 * Base state class for {@link JavaDriverArtificialEntitiesBenchmark#hierarchyStatisticsComputation(JavaDriverArtificialHierarchyBenchmarkState, JavaDriverArtificialHierarchyStatisticsComputationState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Thread)
public class JavaDriverArtificialHierarchyStatisticsComputationState extends AbstractJavaDriverArtificialState implements RandomQueryGenerator {
