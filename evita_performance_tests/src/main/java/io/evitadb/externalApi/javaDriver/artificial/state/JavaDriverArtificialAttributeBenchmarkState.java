...
/**
 * Base state class for attribute-related benchmarks.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class JavaDriverArtificialAttributeBenchmarkState extends JavaDriverArtificialFullDatabaseBenchmarkState
