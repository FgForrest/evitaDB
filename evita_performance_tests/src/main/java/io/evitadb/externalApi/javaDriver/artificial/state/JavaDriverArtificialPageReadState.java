...
import io.evitadb.externalApi.javaDriver.artificial.JavaDriverArtificialFullDatabaseBenchmarkState;
...
/**
 * Base state class for {@link JavaDriverArtificialEntitiesBenchmark#paginatedEntityRead(JavaDriverArtificialFullDatabaseBenchmarkState, JavaDriverArtificialPageReadState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class JavaDriverArtificialPageReadState extends AbstractJavaDriverArtificialState {
