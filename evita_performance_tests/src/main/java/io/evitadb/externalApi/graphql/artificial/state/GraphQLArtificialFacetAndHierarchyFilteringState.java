...
/**
 * Base state class for {@link GraphQLArtificialEntitiesBenchmark#facetAndHierarchyFiltering(GraphQLArtificialFacetBenchmarkState, GraphQLArtificialFacetAndHierarchyFilteringState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class GraphQLArtificialFacetAndHierarchyFilteringState extends AbstractGraphQLArtificialState implements GraphQLRandomQueryGenerator {
