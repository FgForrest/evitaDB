...
/**
 * Base state class for {@link GraphQLArtificialEntitiesBenchmark#parentsComputation(GraphQLArtificialHierarchyBenchmarkState, GraphQLArtificialParentsComputationState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class GraphQLArtificialParentsComputationState extends AbstractGraphQLArtificialState implements GraphQLRandomQueryGenerator {
