...
/**
 * Base state class for {@link GraphQLArtificialEntitiesBenchmark#facetFilteringAndSummarizingCount(GraphQLArtificialFacetBenchmarkState, GraphQLArtificialFacetFilteringAndSummarizingCountState, Blackhole)}.
