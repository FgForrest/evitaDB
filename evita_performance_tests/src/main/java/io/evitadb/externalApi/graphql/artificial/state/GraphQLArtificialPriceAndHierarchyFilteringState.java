...
/**
 * Base state class for {@link GraphQLArtificialEntitiesBenchmark#priceAndHierarchyFiltering(GraphQLArtificialPriceBenchmarkState, GraphQLArtificialPriceAndHierarchyFilteringState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class GraphQLArtificialPriceAndHierarchyFilteringState extends AbstractGraphQLArtificialState implements GraphQLRandomQueryGenerator {
