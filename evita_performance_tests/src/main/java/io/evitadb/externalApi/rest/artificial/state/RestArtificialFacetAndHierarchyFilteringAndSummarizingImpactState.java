...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#facetAndHierarchyFilteringAndSummarizingImpact(RestArtificialFacetBenchmarkState, RestArtificialFacetAndHierarchyFilteringAndSummarizingImpactState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialFacetAndHierarchyFilteringAndSummarizingImpactState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
