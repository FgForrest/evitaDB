...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#priceAndHierarchyFiltering(RestArtificialPriceBenchmarkState, RestArtificialPriceAndHierarchyFilteringState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialPriceAndHierarchyFilteringState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
