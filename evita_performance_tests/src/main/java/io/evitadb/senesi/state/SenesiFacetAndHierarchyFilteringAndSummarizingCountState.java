...
import io.evitadb.client.state.ClientFacetAndHierarchyFilteringAndSummarizingCountState;
...
public class SenesiFacetAndHierarchyFilteringAndSummarizingCountState
