...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#attributeFiltering(ArtificialAttributeBenchmarkState, ArtificialAttributeFilteringState, Blackhole)}.
