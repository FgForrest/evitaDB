...
import io.evitadb.artificial.ArtificialFullDatabaseBenchmarkState;
...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#singleEntityRead(ArtificialFullDatabaseBenchmarkState, ArtificialSingleReadState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */

public class ArtificialSingleReadState extends AbstractArtificialState {

	/**
	 * Prepares artificial product for the next operation that is measured in the benchmark.
	 */
	@Setup(Level.Invocation)
	public void prepareCall(ArtificialFullDatabaseBenchmarkState benchmarkState) {
