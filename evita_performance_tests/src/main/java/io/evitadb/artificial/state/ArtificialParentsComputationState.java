...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#parentsComputation(ArtificialHierarchyBenchmarkState, ArtificialParentsComputationState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class ArtificialParentsComputationState extends AbstractArtificialState implements RandomQueryGenerator {
	...
	public void prepareCall(ArtificialHierarchyBenchmarkState benchmarkState) {
