...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#priceAndHierarchyFiltering(ArtificialPriceBenchmarkState, ArtificialPriceAndHierarchyFilteringState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class ArtificialPriceAndHierarchyFilteringState extends AbstractArtificialState implements RandomQueryGenerator {
