...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#attributeHistogramComputation(ArtificialAttributeBenchmarkState, ArtificialAttributeHistogramState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class ArtificialAttributeHistogramState extends AbstractArtificialState implements RandomQueryGenerator {
