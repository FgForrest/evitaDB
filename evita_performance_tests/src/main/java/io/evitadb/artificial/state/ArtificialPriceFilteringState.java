...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#priceFiltering(ArtificialPriceBenchmarkState, ArtificialPriceFilteringState, Blackhole)}.
