...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#facetAndHierarchyFilteringAndSummarizingCount(ArtificialFacetBenchmarkState, ArtificialFacetAndHierarchyFilteringAndSummarizingCountState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class ArtificialFacetAndHierarchyFilteringAndSummarizingCountState extends AbstractArtificialState implements RandomQueryGenerator {
