...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#hierarchyStatisticsComputation(ArtificialHierarchyBenchmarkState, ArtificialHierarchyStatisticsComputationState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Thread)
public class ArtificialHierarchyStatisticsComputationState extends AbstractArtificialState implements RandomQueryGenerator {
