...
/**
 * Base state class for priceFiltering tests on client data set.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public abstract class ClientPriceFilteringState extends ClientDataFullDatabaseState
	...
	public void prepareCall() {
		this.query = generateRandomPriceQuery(this.random, this.productSchema, this.priceStatistics);
	}
