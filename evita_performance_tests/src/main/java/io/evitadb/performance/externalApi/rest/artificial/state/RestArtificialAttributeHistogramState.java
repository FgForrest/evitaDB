...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#attributeHistogramComputation(RestArtificialAttributeBenchmarkState, RestArtificialAttributeHistogramState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialAttributeHistogramState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
	...
	public void prepareCall(RestArtificialAttributeBenchmarkState benchmarkState) {
		final RestQuery restQuery = generateRandomAttributeHistogramQuery(
