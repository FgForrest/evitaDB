...
/**
 * Base state class for {@link GrpcArtificialEntitiesBenchmark#singleEntityRead(GrpcArtificialFullDatabaseBenchmarkState, GrpcArtificialSingleReadState, Blackhole)}.
