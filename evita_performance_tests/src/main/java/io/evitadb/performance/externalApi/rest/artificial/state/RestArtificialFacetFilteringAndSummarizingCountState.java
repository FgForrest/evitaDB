...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#facetFilteringAndSummarizingCount(RestArtificialFacetBenchmarkState, RestArtificialFacetFilteringAndSummarizingCountState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialFacetFilteringAndSummarizingCountState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
	...
	public void prepareCall(RestArtificialFacetBenchmarkState benchmarkState) {
		final RestQuery restQuery = generateRandomFacetSummaryQuery(
