...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#parentsComputation(RestArtificialHierarchyBenchmarkState, RestArtificialParentsComputationState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialParentsComputationState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
	...
	public void prepareCall(RestArtificialHierarchyBenchmarkState benchmarkState) {
