...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#priceHistogramComputation(RestArtificialPriceBenchmarkState, RestArtificialPriceHistogramState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialPriceHistogramState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
