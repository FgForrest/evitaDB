...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#facetAndHierarchyFiltering(RestArtificialFacetBenchmarkState, RestArtificialFacetAndHierarchyFilteringState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialFacetAndHierarchyFilteringState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
