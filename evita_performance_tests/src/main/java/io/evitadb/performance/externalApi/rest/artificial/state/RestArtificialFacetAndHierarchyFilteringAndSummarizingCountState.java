...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#facetAndHierarchyFilteringAndSummarizingCount(RestArtificialFacetBenchmarkState, RestArtificialFacetAndHierarchyFilteringAndSummarizingCountState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialFacetAndHierarchyFilteringAndSummarizingCountState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
