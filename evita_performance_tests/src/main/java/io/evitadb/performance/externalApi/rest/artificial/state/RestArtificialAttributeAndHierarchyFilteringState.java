...
/**
 * Base state class for {@link RestArtificialEntitiesBenchmark#attributeAndHierarchyFiltering(RestArtificialAttributeBenchmarkState, RestArtificialAttributeAndHierarchyFilteringState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class RestArtificialAttributeAndHierarchyFilteringState extends AbstractRestArtificialState implements RestRandomQueryGenerator {
