...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#facetFilteringAndSummarizingCount(ArtificialFacetBenchmarkState,ArtificialFacetFilteringAndSummarizingCountState, Blackhole)}.
