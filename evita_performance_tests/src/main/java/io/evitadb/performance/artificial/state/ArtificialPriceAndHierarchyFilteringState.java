...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#priceAndHierarchyFiltering(ArtificialPriceBenchmarkState, ArtificialPriceAndHierarchyFilteringState, Blackhole)}.
