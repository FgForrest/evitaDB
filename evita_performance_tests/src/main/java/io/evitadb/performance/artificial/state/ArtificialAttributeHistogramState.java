...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#attributeHistogramComputation(ArtificialAttributeBenchmarkState, ArtificialAttributeHistogramState, Blackhole)}.
