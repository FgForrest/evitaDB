...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#attributeAndHierarchyFiltering(ArtificialAttributeBenchmarkState, ArtificialAttributeAndHierarchyFilteringState, Blackhole)}.
