...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#facetAndHierarchyFilteringAndSummarizingCount(ArtificialFacetBenchmarkState, ArtificialFacetAndHierarchyFilteringAndSummarizingCountState, Blackhole)}.
