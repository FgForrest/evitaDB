...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#parentsComputation(ArtificialHierarchyBenchmarkState, ArtificialParentsComputationState, Blackhole)}.
