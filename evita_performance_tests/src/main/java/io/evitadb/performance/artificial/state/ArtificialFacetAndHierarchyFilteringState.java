...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#facetAndHierarchyFiltering(ArtificialFacetBenchmarkState, ArtificialFacetAndHierarchyFilteringState, Blackhole)}.
