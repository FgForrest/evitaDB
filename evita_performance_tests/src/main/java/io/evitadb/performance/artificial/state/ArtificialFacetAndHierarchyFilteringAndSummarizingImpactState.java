...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#facetAndHierarchyFilteringAndSummarizingImpact(ArtificialFacetBenchmarkState, ArtificialFacetAndHierarchyFilteringAndSummarizingImpactState, Blackhole)}.
