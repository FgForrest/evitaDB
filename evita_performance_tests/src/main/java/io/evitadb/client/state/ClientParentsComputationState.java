...
package io.evitadb.client.state;
...
/**
 * Base state class for parentsComputation tests on client data set.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public abstract class ClientParentsComputationState extends ClientDataFullDatabaseState
	...
	protected void processCreatedEntityReference(EntityReference entity) {
		...
		if (entity.getType().equals(PRODUCT_ENTITY_TYPE) && entity.getPrimaryKey() > maxProductId) {
