...
/**
 * Mutation is responsible for setting value to a {@link AttributeSchemaContract#getConflictResolutionOverride()}
...
public class SetAttributeSchemaConflictResolutionOverrideMutation
	...
	@Serial private static final long serialVersionUID = 7729780450108286115L;
	@Getter @Nonnull private final ConflictResolutionOverride conflictResolutionOverride;

	/**
	 * Creates a mutation that will change the conflict resolution override of an existing attribute schema.
	 *
	 * @param name                       name of the attribute schema to modify
	 * @param conflictResolutionOverride new value of the conflict resolution override
	 */
	public SetAttributeSchemaConflictResolutionOverrideMutation(
		@Nonnull String name,
	...
	public MutationCombinationResult<LocalCatalogSchemaMutation> combineWith(@Nonnull CatalogSchemaContract currentCatalogSchema, @Nonnull LocalCatalogSchemaMutation existingMutation) {
		if (existingMutation instanceof SetAttributeSchemaConflictResolutionOverrideMutation theExistingMutation && this.name.equals(theExistingMutation.getName())) {
	...
	public <S extends AttributeSchemaContract> S mutate(@Nullable CatalogSchemaContract catalogSchema, @Nullable S attributeSchema, @Nonnull Class<S> schemaType) {
		...
		if (attributeSchema.getConflictResolutionOverride() == this.conflictResolutionOverride) {
