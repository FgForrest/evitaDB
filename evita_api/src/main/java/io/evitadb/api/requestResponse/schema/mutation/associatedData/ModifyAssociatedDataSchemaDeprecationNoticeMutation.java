...
/**
 * Mutation is responsible for setting value to a {@link AssociatedDataSchemaContract#getDeprecationNotice()}
...
public class ModifyAssociatedDataSchemaDeprecationNoticeMutation
	...
	public MutationCombinationResult<EntitySchemaMutation> combineWith(@Nonnull CatalogSchemaContract currentCatalogSchema, @Nonnull EntitySchemaContract currentEntitySchema, @Nonnull EntitySchemaMutation existingMutation) {
		if (existingMutation instanceof ModifyAssociatedDataSchemaDeprecationNoticeMutation theExistingMutation && name.equals(theExistingMutation.getName())) {
