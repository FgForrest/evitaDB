...
public class ModifySortableAttributeCompoundSchemaDeprecationNoticeMutation
	...
	public MutationCombinationResult<EntitySchemaMutation> combineWith(@Nonnull CatalogSchemaContract currentCatalogSchema, @Nonnull EntitySchemaContract currentEntitySchema, @Nonnull EntitySchemaMutation existingMutation) {
		if (existingMutation instanceof ModifySortableAttributeCompoundSchemaDeprecationNoticeMutation theExistingMutation && name.equals(theExistingMutation.getName())) {
