...
public final class EntitySchema implements EntitySchemaContract {
	@Serial private static final long serialVersionUID = 8694215716025515884L;
	...
	/**
	 * Optional transaction conflict resolution override for this entity collection. A `null` value means the entity
	 * collection inherits the setting from the catalog schema (which in turn inherits from the engine configuration).
	 * See {@link EntitySchemaContract#getConflictResolution()}.
	 */
