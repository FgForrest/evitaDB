...
public class ModifyAttributeSchemaDescriptionMutation
	...
	@Serial private static final long serialVersionUID = 4856557039691866413L;
	...
	public MutationCombinationResult<LocalCatalogSchemaMutation> combineWith(
		...
		if (existingMutation instanceof ModifyAttributeSchemaDescriptionMutation theExistingMutation &&
	...
	public <S extends AttributeSchemaContract> S mutate(
		...
		if (Objects.equals(attributeSchema.getDescription(), this.description)) {
