 ...
 */
public record ReferenceConflictKey(
	...
	public String toString() {
		return "reference `" + this.referenceName + "` (ref. PK=" + this.referencePrimaryKey + ") of entity `" + this.entityType + "` with primary key `" + this.entityPrimaryKey + '`';
	}
