...
public class Entity implements SealedEntity {
	...
	/**
	 * Unique Integer positive number (max. 2^63-1) representing the entity. Can be used for fast lookup for
	...
	private static PriceInnerRecordHandling mutateInnerPriceRecordHandling(
		...
		return ofNullable(newPriceContainer)
	...
	private static Integer mutateHierarchyPlacement(
		...
		final OptionalInt newParent = parentMutation.mutateLocal(entitySchema, existingPlacement);
	...
	public boolean equals(Object o) {
		...
		return this.version == entity.version &&
			this.type.equals(entity.type) &&
			Objects.equals(this.primaryKey, entity.primaryKey);
	}
