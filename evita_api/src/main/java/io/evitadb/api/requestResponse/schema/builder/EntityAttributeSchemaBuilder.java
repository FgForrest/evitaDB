...
public final class EntityAttributeSchemaBuilder
	...
	EntityAttributeSchemaBuilder(
		...
		super(null, entitySchema, EntityAttributeSchema._internalBuild(name, ofType, false, ConflictResolutionOverride.INHERITED));
		this.mutations.add(
	...
	@Nonnull
	@Override
	protected EntityAttributeSchemaContract assembleInstance() {
