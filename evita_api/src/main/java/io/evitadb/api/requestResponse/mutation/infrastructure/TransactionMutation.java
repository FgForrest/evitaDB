...
package io.evitadb.api.requestResponse.mutation.infrastructure;
...
/**
 * This transaction mutation delimits mutations of one transaction
 * from another. It contains data that allows recognizing
...
public non-sealed class TransactionMutation implements EngineMutation<Void>, CatalogBoundMutation {
	 ...
	 */
	@Nonnull @Getter protected final UUID transactionId;
	/**
	 ...
	 */
	@Nonnull @Getter protected final OffsetDateTime commitTimestamp;

	/**
	 * Creates instance of the mutation.
	 *
	 * @param transactionId   the unique identifier of the transaction
	 * @param version         the catalog version this transaction
	 *                        transitions the state to
	 * @param mutationCount   the number of mutations in this transaction
	 * @param walSizeInBytes  the size of the serialized transaction
	 *                        mutations in bytes
	...
	public String toString() {
		return "transaction commit `" + this.transactionId
