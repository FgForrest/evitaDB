...
public class SetAttributeSchemaNullableMutation
	...
	public MutationCombinationResult<LocalCatalogSchemaMutation> combineWith(
		...
		if (existingMutation instanceof SetAttributeSchemaNullableMutation theExistingMutation &&
	...
	public MutationCombinationResult<LocalEntitySchemaMutation> combineWith(
		...
		if (existingMutation instanceof SetAttributeSchemaNullableMutation theExistingMutation && this.name.equals(theExistingMutation.getName())) {
			return new MutationCombinationResult<>(null, this);
		} else {
			return null;
		}
