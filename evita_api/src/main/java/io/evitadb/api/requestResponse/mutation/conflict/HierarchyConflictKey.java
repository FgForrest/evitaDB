...
/**
 * Entity hierarchy-level conflict key for serializing concurrent engine mutations.
 *
 ...
 */
public record HierarchyConflictKey(
	 ...
	 * {@inheritDoc}
	 *
	 * @return {@link ConflictScope#HIERARCHY}
	 */
	@Nonnull
	@Override
	public ConflictScope conflictScope() {
		return ConflictScope.HIERARCHY;
	}
	...
	public String toString() {
		return "hierarchy of entity `" + this.entityType + "` with primary key `" + this.entityPrimaryKey + '`';
	}
