 ...
 */
public interface EntitySchemaEditor<S extends EntitySchemaEditor<S>>
	extends EntitySchemaContract, AttributeProviderSchemaEditor<S, AttributeSchemaContract, AttributeSchemaEditor.AttributeSchemaBuilder> {
	...
	/**
	 * Marking entity as deprecated allows you to inform users of your client API that this type of entity is planned
	 * for removal in the future. You should also describe the reasons behind this decision in the form of deprecation
	 * notice. Description is expected to be written using
	...
	/**
	 * This method should be used carefully only in case some entity was marked as deprecated by mistake.
