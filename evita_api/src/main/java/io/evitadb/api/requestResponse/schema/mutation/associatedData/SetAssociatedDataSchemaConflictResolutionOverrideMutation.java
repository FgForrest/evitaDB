...
/**
 * Mutation is responsible for setting value to a
 * {@link AssociatedDataSchemaContract#getConflictResolutionOverride()} in {@link EntitySchemaContract}.
...
public class SetAssociatedDataSchemaConflictResolutionOverrideMutation
	extends AbstractModifyAssociatedDataSchemaMutation implements CombinableLocalEntitySchemaMutation {
	@Serial private static final long serialVersionUID = -6745601976923078414L;
	@Getter @Nonnull private final ConflictResolutionOverride conflictResolutionOverride;

	/**
	 * Creates a mutation that will change the conflict resolution override of an existing associated data schema.
	 *
	 ...
	 */
	public SetAssociatedDataSchemaConflictResolutionOverrideMutation(
		@Nonnull String name,
	...
	public MutationCombinationResult<LocalEntitySchemaMutation> combineWith(
		...
		if (existingMutation instanceof SetAssociatedDataSchemaConflictResolutionOverrideMutation theExistingMutation && this.name.equals(
