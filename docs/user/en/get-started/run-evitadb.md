...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_db:0.7-INTERNAL'
```
</CodeTabsBlock>
</CodeTabs>
...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_external_api_grpc:0.7-INTERNAL'
```
</CodeTabsBlock>
</CodeTabs>
...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_external_api_graphql:0.7-INTERNAL'
```
</CodeTabsBlock>
</CodeTabs>
...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_external_api_rest:0.7-INTERNAL'
```
</CodeTabsBlock>
</CodeTabs>
