...
/**
 * Regression tests for {@link PersistentLongRoaringBitmap}, ported from the upstream
 * RoaringBitmap 64-bit test-suite. They exercise construction and equality, value
 * addition / removal / cardinality, selection and ranking, forward and reverse iteration
 * and streaming, the set-algebra operations (`or` / `and` / `xor` / `andNot`), range
 * addition and flipping, serialization round-trips, peekable-iterator skipping and
 * advancing and the `forAllInRange` / `forEachInRange` consumers.
 *
 * Retained as a regression guard for the vendored `io.evitadb.roaringbitmap` module; the
 * test bodies are kept byte-for-byte identical to the upstream port to ease future syncs.
 */
@DisplayName("PersistentLongRoaringBitmap (64-bit) behaviour")
public class TestRoaring64Bitmap {
	...
	@Nested
	@DisplayName("Construction, equality, cloning and representation")
	class ConstructionAndRepresentation {

		@DisplayName("Two bitmaps are equal iff they hold the same values")
		@Test
		...
		@DisplayName("Equal bitmaps share the same hash code")
		@Test
		...
		@DisplayName("Cloning an empty bitmap yields an equal empty bitmap")
		@Test
	...
	@Nested
	@DisplayName("Adding values, containment and cardinality")
	class AddingAndCardinality {

		@DisplayName("Empty bitmap reports zero cardinality and rank")
		@Test
		...
		@DisplayName("Adding zero makes it selectable and ranked")
		@Test
		...
		@DisplayName("-1 is stored and ranked as the largest unsigned value")
		@Test
		...
		@DisplayName("Two small integers are stored, ranked and selected in order")
		@Test
		...
		@DisplayName("addInt stores the value as an unsigned 32-bit long")
		@Test
		...
		@DisplayName("addInt with all bits set is treated as unsigned")
		@Test
		public void testInvalidIntMask() {
			...
			map.addInt(a);
			assertEquals(1, map.getIntCardinality());
			long addedInt = map.getLongIterator().next();
			assertEquals(0xFFFFFFFFL, addedInt);
		}

		@DisplayName("Long.MAX_VALUE is stored and ranked correctly")
		@Test
		...
		@DisplayName("Long.MIN_VALUE is stored and ranked correctly")
		@Test
		...
		@DisplayName("Signed extremes iterate in unsigned order")
		@Test
		...
		@DisplayName("A low value added after a high value sorts first")
		@Test
		...
		@DisplayName("0, Long.MAX_VALUE and -1 coexist in unsigned order")
		@Test
	...
	@Nested
	@DisplayName("Selection and ranking")
	class SelectionAndRanking {

		@DisplayName("select past cardinality throws IllegalArgumentException")
		@Test
		...
		@DisplayName("select returns positive then negative values in unsigned order")
		@Test
		...
		@DisplayName("rank counts values up to and including a negative key")
		@Test
		...
		@DisplayName("select spans multiple high-part buckets")
		@Test
		...
		@DisplayName("select on an empty bitmap throws")
		@Test
		...
		@DisplayName("select at cardinality throws")
		@Test
		...
		@DisplayName("select beyond cardinality throws")
		@Test
		...
		@DisplayName("rank across multiple buckets")
		@Test
		...
		@DisplayName("rank of an absent high value counts lower values")
		@Test
		...
		@DisplayName("One million values across distinct buckets rank correctly")
		@Test
	...
	class IterationAndStreaming {

		@DisplayName("A million random longs are all iterated back")
		@Test
		...
		@DisplayName("Iterator yields positive before negative (unsigned) values")
		@Test
		...
		@DisplayName("next without hasNext returns the value on a filled bitmap")
		@Test
		...
		@DisplayName("next without hasNext throws on an empty bitmap")
		@Test
		...
		@DisplayName("Reverse iterator walks a single bucket descending")
		@Test
		...
		@DisplayName("Reverse iterator walks multiple buckets descending")
		@Test
		...
		@DisplayName("stream yields the same values as the iterator")
		@Test
		...
		@DisplayName("reverseStream matches the reverse iterator")
		@Test
		...
		@DisplayName("Boxed Iterator walks values in order")
		@Test
		...
		@DisplayName("Boxed Iterator.remove is unsupported")
		@Test
		...
		@DisplayName("Leaf-node iterator peekNext matches next until exhausted")
		@Test
	...
	class Removal {
		...
		@DisplayName("Removing the only value empties the bitmap")
		@Test
		...
		@DisplayName("Removing from one bucket preserves the other")
		@Test
		...
		@DisplayName("Removing the high value then adding an intermediate one")
		@Test
		...
		@DisplayName("Removing an intermediate value then adding a high one")
		@Test
		...
		@DisplayName("Randomly added values are all removable chunk by chunk")
		@Test
	...
	class Union {
		...
		@DisplayName("or merges values within the same bucket")
		@Test
		...
		@DisplayName("or merges values across multiple buckets")
		@Test
		...
		@DisplayName("or merges values in different buckets")
		@Test
		...
		@DisplayName("or merges a value into a distant bucket")
		@Test
		...
		@DisplayName("or does not alias the right operand's buckets")
		@Test
	...
	@Nested
	@DisplayName("Intersection (and)")
	class Intersection {

		@DisplayName("and keeps the shared value in one bucket")
		@Test
		...
		@DisplayName("and keeps the single shared value")
		@Test
		public void testAnd() {
			PersistentLongRoaringBitmap left = newDefaultCtor();
			PersistentLongRoaringBitmap right = newDefaultCtor();
		...
		@DisplayName("and of disjoint bitmaps is empty (both orderings)")
		@Test
		...
		@DisplayName("toArray after an emptying and does not throw")
		@Test
		...
		@DisplayName("and of values in different buckets is empty")
		@Test
		...
		@DisplayName("and keeps the shared value across buckets")
		@Test
		...
		@DisplayName("intersects detects any shared value")
		@Test
		...
		@DisplayName("andCardinality matches the cardinality of and")
		@Test
		...
		@DisplayName("andCardinality matches and across many containers")
		@Test
	...
	class SymmetricDifference {
		...
		@DisplayName("xor drops the shared value within a bucket")
		@Test
		...
		@DisplayName("xor keeps the symmetric difference")
		@Test
		public void testXor() {
			PersistentLongRoaringBitmap left = newDefaultCtor();
			PersistentLongRoaringBitmap right = newDefaultCtor();
		...
		@DisplayName("xor of different buckets keeps both values")
		@Test
		...
		@DisplayName("xor removes the shared value across buckets")
		@Test
	...
	@Nested
	@DisplayName("Difference (andNot)")
	class Difference {

		@DisplayName("andNot removes right's values from one bucket")
		@Test
		...
		@DisplayName("andNot keeps only left-exclusive values")
		@Test
		...
		@DisplayName("andNot across different buckets keeps left")
		@Test
		...
		@DisplayName("andNot removes the shared value across buckets")
		@Test
	...
	@Nested
	@DisplayName("Flipping values and ranges")
	class Flip {

		@DisplayName("flip adds an absent value in the same container")
		@Test
		...
		@DisplayName("flip toggles a value in a middle container")
		@Test
		...
		@DisplayName("flip toggles a value in the next container")
		@Test
		...
		@DisplayName("flip toggles a value at the container edge")
		@Test
		...
		@DisplayName("flip spans across a container boundary")
		@Test
		...
		@DisplayName("flip toggles a value in a prior container")
		@Test
		...
		@DisplayName("flip of an empty range is a no-op")
		@Test
		...
		@DisplayName("flip with start > end (positive) is a no-op")
		@Test
		...
		@DisplayName("flip with start > end (negative) is a no-op")
		@Test
		...
		@DisplayName("flip from negative start to positive end is a no-op")
		@Test
		...
		@DisplayName("flip across the signed boundary (hex) toggles values")
		@Test
		...
		@DisplayName("flip across the signed boundary (decimal) toggles values")
		@Test
		...
		@DisplayName("flip of a small range in the negative space works")
		@Test
		...
		@DisplayName("flip up to zero across the long edge works")
		@Test
		...
		@DisplayName("flip(value) removes a present value")
		@Test
		...
		@DisplayName("flip removes zero when present")
		@Test
	...
	@Nested
	@DisplayName("Range operations and optimization")
	class RangeOperations {

		@DisplayName("addRange rejects empty or reversed ranges")
		@Test
		...
		@DisplayName("addRange fills a range within one bucket")
		@Test
		...
		@DisplayName("addRange excludes the end value at a bucket boundary")
		@Test
		...
		@DisplayName("addRange spans multiple buckets")
		@Test
		...
		@DisplayName("32-bit bitmap rejects a range beyond Integer.MAX_VALUE")
		@Test
		...
		@DisplayName("64-bit bitmap fills a range beyond Integer.MAX_VALUE")
		@Test
		...
		@DisplayName("32-bit bitmap selects across the full unsigned range")
		@Test
		...
		@DisplayName("trim compacts a bitmap spanning buckets")
		@Test
		...
		@DisplayName("addRange wraps around Long.MAX_VALUE into negatives")
		@Test
		...
		@DisplayName("addRange near the unsigned maximum")
		@Test
		...
		@DisplayName("runOptimize leaves the values intact")
		@Test
	...
	class Serialization {
		...
		@DisplayName("All ART node types survive stream and ByteBuffer round-trips")
		@Test
		...
		@DisplayName("Empty bitmap serializes and deserializes")
		@Test
		...
		@DisplayName("serialize advances a big-endian buffer by its size")
		@Test
		...
		@DisplayName("Single-value bitmap round-trips")
		@Test
		...
		@DisplayName("Bitmap round-trips via object serialization")
		@Test
		...
		@DisplayName("Multi-bucket bitmap round-trips via stream and ByteBuffer")
		@Test
		...
		@DisplayName("Serialized length matches serializedSizeInBytes")
		@Test
	...
	@Nested
	@DisplayName("Skipping and advancing iterators")
	class SkippingAndAdvancing {

		@DisplayName("advanceIfNeeded and getLongIteratorFrom hit every value")
		@Test
		...
		@DisplayName("Skipping works on a dense bitmap")
		@Test
		...
		@DisplayName("Skipping works across multiple high points")
		@Test
		...
		@DisplayName("Skipping works on a run-optimized bitmap")
		@Test
		...
		@DisplayName("Skipping on an empty bitmap does not crash")
		@Test
		...
		@DisplayName("Reverse advanceIfNeeded hits every value")
		@Test
		...
		@DisplayName("Reverse skipping works on a dense bitmap")
		@Test
		...
		@DisplayName("Reverse skipping works across multiple high points")
		@Test
		...
		@DisplayName("Reverse skipping works on a run-optimized bitmap")
		@Test
		...
		@DisplayName("Reverse skipping on an empty bitmap does not crash")
		@Test
		...
		@DisplayName("Advancing into a gap lands on the next present value")
		@Test
		...
		@DisplayName("Advancing into a far gap lands on the next range")
		@Test
		...
		@DisplayName("Reverse advancing into a gap lands on the prior value")
		@Test
		...
		@DisplayName("Reverse advancing into a far gap lands on the prior range")
		@Test
		...
		@DisplayName("advanceIfNeeded treats longs as unsigned")
		@Test
		...
		@DisplayName("Reverse advanceIfNeeded treats longs as unsigned")
		@Test
	...
	@Nested
	@DisplayName("Range consumers (forAllInRange / forEachInRange)")
	class RangeConsumers {

		@DisplayName("forAllInRange reports presence over a continuous bitmap")
		@Test
		...
		@DisplayName("forAllInRange reports presence over a dense bitmap")
		@Test
		...
		@DisplayName("forAllInRange reports presence over a sparse bitmap")
		@Test
		...
		@DisplayName("forEachInRange over an empty range visits nothing")
		@Test
		...
		@DisplayName("forEachInRange visits values in range in order")
		@Test
		public void testIssue577Case3() {
			...
			bitmap.forEachInRange(
				...
				new LongConsumer() {
					...
					@Override
					public void accept(long value) {
						assertEquals(expected[this.offset], value);
						this.offset++;
					}
				}
			);
	...
	class FirstAndLast {
		...
		@DisplayName("first on an empty bitmap throws NoSuchElementException")
		@Test
		public void testEmptyFirst() {
			assertThrows(NoSuchElementException.class, () -> newDefaultCtor().first());
		}

		@DisplayName("last on an empty bitmap throws NoSuchElementException")
		@Test
		public void testEmptyLast() {
			assertThrows(NoSuchElementException.class, () -> newDefaultCtor().last());
		}

		@DisplayName("first and last over 32-bit values")
		@Test
		...
		@DisplayName("first and last over negative (high) values")
		@Test
		...
		@DisplayName("first and last across 32- and 64-bit values")
		@Test
		...
		@DisplayName("first and last match unsigned min and max over all node types")
		@Test
	...
	class RegressionScenarios {
		...
		@DisplayName("and/or/andNot across distant buckets keep correct cardinalities")
		@Test
		...
		@DisplayName("and against a far bitmap does not throw NullPointerException")
		@Test
		...
		@DisplayName("and against a far bitmap does not throw ArrayIndexOutOfBoundsException")
		@Test
		...
		@DisplayName("and against a far bitmap does not throw IllegalArgumentException")
		@Test
		...
		@DisplayName("Repeated and does not resurrect an absent value")
		@Test
		...
		@DisplayName("Interleaved add and remove of random longs is stable")
		@Test
		...
		@DisplayName("Self set-operations behave (or/and identity, xor/andNot empty)")
		@Test
		...
		@DisplayName("Iterator counts all values of a seven-element bitmap")
		@Test
		...
		@DisplayName("Repeated andNot converges to a stable cardinality")
		@Test
		...
		@DisplayName("64-bit bitmap orders values like the 32-bit unsigned bitmap")
		@Test
