 ...
 * {@link PersistentRoaringBitmap#bitmapOfUnordered} produces a bitmap identical to
 * {@link PersistentRoaringBitmap#bitmapOf} across randomly generated inputs.
 */
@Execution(ExecutionMode.CONCURRENT)
@DisplayName("PersistentRoaringBitmap.bitmapOfUnordered (randomised)")
public class UnorderedRoaringBitmapWriterRandomisedTest {
	...
	public void bitmapOfUnorderedShouldBuildSameBitmapAsBitmapOf(int[] data) {
		PersistentRoaringBitmap baseline = PersistentRoaringBitmap.bitmapOf(data);
		PersistentRoaringBitmap test = PersistentRoaringBitmap.bitmapOfUnordered(data);
