...
import io.evitadb.roaringbitmap.ValidationRangeConsumer.Value;
...
/**
 * Verifies `PersistentRoaringBitmap#forAllInRange` across continuous, dense and sparse layouts.
 */
@DisplayName("PersistentRoaringBitmap forAllInRange range iteration")
public class TestForAllInRange {
	...
	public void testContinuous(int offset) {
		...
		bitmap = new PersistentRoaringBitmap();
	...
	public void readToEnd() {
		...
		PersistentRoaringBitmap emptyBitmap = new PersistentRoaringBitmap();
		...
		PersistentRoaringBitmap emptyLastContainerBitmap = new PersistentRoaringBitmap();
