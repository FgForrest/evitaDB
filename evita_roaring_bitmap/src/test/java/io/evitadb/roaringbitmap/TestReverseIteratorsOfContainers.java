...
/**
 * Regression tests for the forward and reverse {@link PeekableCharIterator}s exposed by every
 * container type, ported from the upstream RoaringBitmap test suite. Each test runs against an
 * array, bitmap and run container (supplied by {@link ContainerProvider}) and exercises
 * {@code advanceIfNeeded} skipping, including the empty-container and out-of-range edge cases.
 */
@DisplayName("Container forward and reverse skip iteration")
public class TestReverseIteratorsOfContainers {

	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Forward iterator skips to arbitrary present values")
	...
	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Forward iterator skips within a dense container")
	...
	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Forward iterator skips within a run container")
	...
	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Forward skip on an empty container does not crash")
	...
	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Reverse iterator skips to arbitrary present values")
	...
	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Reverse iterator skips within a dense container")
	...
	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Reverse iterator skips within a run container")
	...
	@ParameterizedTest
	@ArgumentsSource(TestReverseIteratorsOfContainers.ContainerProvider.class)
	@DisplayName("Reverse skip on an empty container does not crash")
	...
	static class ContainerProvider implements ArgumentsProvider {
		...
		public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
			return this.streams.map(f -> Arguments.of(f));
		}
	}
}
