...
/**
 * Verifies `PersistentRoaringBitmap#contains` subset semantics across container-type combinations.
 */
@DisplayName("PersistentRoaringBitmap subset containment")
public class RoaringBitmapSubsetTest {
	...
	public void testProperSubset(Set<Integer> superSet, Set<Integer> subSet) {
		PersistentRoaringBitmap superSetRB = create(superSet);
		PersistentRoaringBitmap subSetRB = create(subSet);
	...
	private PersistentRoaringBitmap create(Set<Integer> set) {
