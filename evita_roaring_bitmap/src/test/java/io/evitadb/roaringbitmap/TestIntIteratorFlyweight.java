...
/**
 * Regression tests for {@link IntIteratorFlyweight} and {@link ReverseIntIteratorFlyweight}, ported
 * from the upstream RoaringBitmap test suite. They verify that the reusable flyweight iterators
 * reproduce a bitmap's contents forward and in reverse, honour `peekNext` and `advanceIfNeeded`, and
 * behave correctly across `wrap`, constructor and `clone` based initialization.
 */
@Execution(ExecutionMode.CONCURRENT)
@DisplayName("IntIteratorFlyweight forward and reverse iteration")
public class TestIntIteratorFlyweight {
	...
	@Test
	@DisplayName("Wrapped empty bitmap yields no forward or reverse elements")
	...
	@Test
	@DisplayName("Wrapped iterator reproduces a large optimized bitmap and supports peek/advance")
	...
	@Test
	@DisplayName("Constructor-wrapped iterator reproduces a large optimized bitmap and supports peek/advance")
	...
	@Test
	@DisplayName("Cloned iterator reproduces the source bitmap forward and in reverse")
	...
	@Test
	@DisplayName("Mixed run and array containers iterate forward and in reverse")
	...
	@Test
	@DisplayName("Small bitmap iterates forward and in reverse")
	public void testSmallIteration() {
		PersistentRoaringBitmap bitmap = PersistentRoaringBitmap.bitmapOf(1, 2, 3);
	...
	@Test
	@DisplayName("Clone yields the same remaining values as the original iterator")
	public void testClone() {
		PersistentRoaringBitmap bitmap = PersistentRoaringBitmap.bitmapOf(1, 2, 3, 4, 5);
		IntIteratorFlyweight iter = new IntIteratorFlyweight(bitmap);
