...
/**
 * Regression tests for {@link Node4}, the smallest ART branch node holding up to four
 * children. They cover insertion ordering, positional removal, nearest-child search,
 * positional navigation over the stored children and a serialization round-trip.
 *
...
public class Node4Test {
	...
	@Test
	@DisplayName("Insert, remove, serialize round-trip and collapse to a leaf")
	...
	@Nested
	@DisplayName("Insertion ordering")
	class Insertion {
		@Test
	...
	@Nested
	@DisplayName("Removal by position")
	class Removal {
		@Test
