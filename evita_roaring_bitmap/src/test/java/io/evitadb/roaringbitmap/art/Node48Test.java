...
import static io.evitadb.roaringbitmap.art.NodeCommon.checkKeyAndPosAlign;


/**
 * Regression tests for {@link Node48}, the ART branch node holding up to forty-eight
 * children behind a 256-entry position index. They cover capacity transitions to and
 * from neighbouring node types, nearest-child search, positional navigation (including
 * negative keys and edge cases), a serialization round-trip and the byte-packing helper.
 *
...
public class Node48Test {
	...
	@Test
	@DisplayName("Fill, navigate in both directions, serialize round-trip and remove the minimum")
	...
	@Test
	@DisplayName("setOneByte packs bytes into the position-index longs")
	...
	@Nested
	@DisplayName("Capacity transitions (grow / shrink)")
	class CapacityTransitions {
		@Test
	...
	@Nested
	@DisplayName("Nearest-child position search")
	class NearestChildSearch {
		@Test
	...
	@Nested
	@DisplayName("Positional navigation over children")
	class PositionalNavigation {
		@Test
