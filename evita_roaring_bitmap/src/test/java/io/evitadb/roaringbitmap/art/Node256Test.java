...
/**
 * Regression tests for {@link Node256}, the largest ART branch node with a direct
 * 256-entry child table. They cover the shrink path to {@link Node48}, nearest-child
 * search and positional navigation over the stored children.
 *
...
public class Node256Test {
	...
	@Test
	@DisplayName("Fill to capacity, navigate in both directions and remove a middle child")
	public void test() {
