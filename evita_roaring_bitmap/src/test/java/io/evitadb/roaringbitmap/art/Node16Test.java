...
/**
 * Regression tests for {@link Node16}, the ART branch node holding up to sixteen
 * children. They cover the growth path up to {@link Node48}, nearest-child search and
 * positional navigation over the stored children.
 *
...
public class Node16Test {
	...
	@Test
	@DisplayName("Grow from Node4, shrink back to Node4 and re-grow to Node16")
	public void test() {
