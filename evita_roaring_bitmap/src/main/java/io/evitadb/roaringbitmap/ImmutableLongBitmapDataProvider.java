...
public interface ImmutableLongBitmapDataProvider {
	 ...
	 */
	void forEach(@Nonnull LongConsumer lc);
	...
	final class RoaringOfLong implements PrimitiveIterator.OfLong {
		@Nonnull private final LongIterator iterator;

		public RoaringOfLong(@Nonnull final LongIterator iterator) {
