...
/**
 * Used to hold the logic packing 2 integers in a long, and separating a long in two integers. It
 * splits the input long in two integers, one used as key while the other is added in a Bitmap.
 *
