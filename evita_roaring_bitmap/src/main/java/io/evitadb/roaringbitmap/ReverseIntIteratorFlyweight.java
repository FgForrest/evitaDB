...
public class ReverseIntIteratorFlyweight implements IntIterator {
  ...
  private PersistentRoaringBitmap roaringBitmap = null;
   ...
   */
  public ReverseIntIteratorFlyweight(PersistentRoaringBitmap r) {
    wrap(r);
  }
   ...
   * @param r bitmap to be iterated over
   */
  public void wrap(PersistentRoaringBitmap r) {
