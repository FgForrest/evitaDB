...
public final class IntegerNumberRange extends NumberRange<Integer> {
	...
	/**
	 * Method creates new IntegerRange instance.
	 */
	@Nonnull
	...
	/**
	 * Method creates new IntegerRange instance when only lower range bound is available.
	 */
	@Nonnull
	...
	/**
	 * Method creates new IntegerRange instance when only upper range bound is available.
	 */
	@Nonnull
	 ...
	 * by {@link NumberRange#toString()} method. Parsed Number range always uses {@link Integer} for numbers.
	 */
	@Nonnull
	...
	private static Integer parseInt(@Nonnull String toBeNumber) {
		try {
			...
			throw new DataTypeParseException("String " + toBeNumber + " is not an integer number!");
		}
	}
