...
/**
 * Specialization of {@link ExpressionNode} for nodes representing binary operators
 * (arithmetic, comparison, logical, coalescing) that combine exactly two operands.
 *
