 ...
 *    it -> it.getKey(),
 *    Collectors.mapping(it -> it.getValue(), IntegerIntoBitmapCollector.INSTANCE)
 * )
 * ```
 *
...
public class IntegerIntoBitmapCollector implements Collector<Integer, Bitmap, Bitmap> {
	public static final IntegerIntoBitmapCollector INSTANCE = new IntegerIntoBitmapCollector();
