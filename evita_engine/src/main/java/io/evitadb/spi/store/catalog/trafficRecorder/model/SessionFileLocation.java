...
package io.evitadb.spi.store.catalog.trafficRecorder.model;
 ...
 */
public record SessionFileLocation(long startingPosition, int recordLength) implements Serializable {
	@Serial private static final long serialVersionUID = 6408882908172452621L;
	public static final SessionFileLocation EMPTY = new SessionFileLocation(0, 0);
