...
/**
 * A flush-time instruction to REMOVE a single granular standalone (OWNER) {@link io.evitadb.index.attribute.UniqueIndex}
 ...
 *
 * Like {@link UniqueIndexLeafPagePart} on the write path, this carries the sub-index `(entityIndexPrimaryKey,
 ...
 */
public class UniqueIndexLeafPageRemoval implements DeferredRemovalStoragePart {
	@Serial private static final long serialVersionUID = -8423105736294017562L;
	 ...
	 */
	public UniqueIndexLeafPageRemoval(
	...
	public long computeUniquePartIdAndSet(@Nonnull KeyCompressor keyCompressor) {
		...
		final long computedUniquePartId = UniqueIndexLeafPagePart.computeUniquePartId(streamId, this.pageSequence);
	...
	public Class<? extends StoragePart> removedContainerType() {
		return UniqueIndexLeafPagePart.class;
	}
}
