 ...
 */
@Name(ChangeCaptureStatisticsEvent.EVENT_NAME)
@Description("Event that is fired in regular intervals capturing base statistics of CDC.")
@Label("Overall CDC statistics")
@Period("1m")
@Getter
public class ChangeCaptureStatisticsEvent extends AbstractChangeCaptureEvent {
	public static final String EVENT_NAME = AbstractChangeCaptureEvent.PACKAGE_NAME + ".ChangeCaptureStatistics";
	...
	public ChangeCaptureStatisticsEvent(
