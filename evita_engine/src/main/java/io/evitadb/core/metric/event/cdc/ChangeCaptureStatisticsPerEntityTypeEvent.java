 ...
 */
@Name(AbstractChangeCaptureEvent.PACKAGE_NAME + ".ChangeCaptureStatisticsPerEntityType")
@Description("Event that is fired in regular intervals capturing base statistics of CDC per entity type.")
@Label("CDC statistics per entity type")
@Getter
public class ChangeCaptureStatisticsPerEntityTypeEvent extends AbstractChangeCaptureEvent {
	@ExportMetricLabel
	@Label("Entity type")
	...
	public ChangeCaptureStatisticsPerEntityTypeEvent(
