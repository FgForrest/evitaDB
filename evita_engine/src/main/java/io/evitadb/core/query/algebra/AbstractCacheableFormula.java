...
public abstract class AbstractCacheableFormula extends AbstractFormula implements CacheableFormula {
	...
	protected AbstractCacheableFormula(@Nullable Consumer<CacheableFormula> computationCallback, Formula... innerFormulas) {
		super(innerFormulas);
		this.computationCallback = computationCallback;
	}

	protected AbstractCacheableFormula(@Nullable Bitmap memoizedResult, @Nullable Consumer<CacheableFormula> computationCallback, Formula... innerFormulas) {
		super(innerFormulas);
	...
	public Bitmap compute() {
		if (this.memoizedResult == null) {
			...
			ofNullable(computationCallback).ifPresent(it -> it.accept(this));
		}
