...
public class BitmapFavouringNoCachePolicy implements PlanningPolicy {
	public static final BitmapFavouringNoCachePolicy INSTANCE = new BitmapFavouringNoCachePolicy();
