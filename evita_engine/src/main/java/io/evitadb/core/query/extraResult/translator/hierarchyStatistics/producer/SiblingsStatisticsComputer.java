 ...
 */
public class SiblingsStatisticsComputer extends AbstractHierarchyStatisticsComputer {
	...
	protected List<LevelInfo> createStatistics(
		...
		if (context.hierarchyWithin() instanceof HierarchyWithin hierarchyWithin) {
			final OptionalInt parentNode = context.entityIndex().getParentNode(hierarchyWithin.getParentId());
