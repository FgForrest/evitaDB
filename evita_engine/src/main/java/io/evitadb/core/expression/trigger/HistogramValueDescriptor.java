 ...
 *                            `plainType` values
 * @param indexedDecimalPlaces decimal-places scale used to encode `BigDecimal` source values into the
 *                            order-preserving scaled `int` the source filter index stores; `0` for every
 *                            other source type
