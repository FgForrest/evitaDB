...
/**
 * This implementation of {@link CatalogContract} represents a catalog instance that cannot be loaded into a memory
 * deliberately on user request (stored engine configuration). Most methods of this implementation throw
 * {@link CatalogInactiveException} when invoked. The original exception and catalog path are accessible via.
 * {@link #getCatalogStoragePath()}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public final class InactiveCatalog implements CatalogContract {
	...
	public SealedCatalogSchema getSchema() {
		throw new CatalogInactiveException(this);
	}
	...
	@Nonnull
	@Override
	public GoLiveProgress goLive(@Nullable IntConsumer progressObserver) {
		throw new CatalogInactiveException(this);
	}
