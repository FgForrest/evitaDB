...
public class FacetSummarySerializer extends Serializer<FacetSummary> {

	@Override
	public void write(Kryo kryo, Output output, FacetSummary object) {
	...
	@Override
	public FacetSummary read(Kryo kryo, Input input, Class<? extends FacetSummary> type) {
