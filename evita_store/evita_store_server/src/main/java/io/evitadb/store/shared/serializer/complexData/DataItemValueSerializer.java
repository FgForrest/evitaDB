...
package io.evitadb.store.shared.serializer.complexData;
...
/**
 * This {@link Serializer} implementation reads/writes {@link DataItemValue} from/to binary format.
 *
...
public class DataItemValueSerializer extends Serializer<DataItemValue> {
	...
	@Override
	public DataItemValue read(Kryo kryo, Input input, Class<? extends DataItemValue> type) {
