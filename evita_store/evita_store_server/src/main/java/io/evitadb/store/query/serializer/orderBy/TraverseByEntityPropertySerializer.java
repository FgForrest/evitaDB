...
/**
 * This {@link Serializer} implementation reads/writes {@link TraverseByEntityProperty} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2025
 */
@RequiredArgsConstructor
public class TraverseByEntityPropertySerializer extends Serializer<TraverseByEntityProperty> {

	@Override
	public void write(Kryo kryo, Output output, TraverseByEntityProperty object) {
		kryo.writeObject(output, object.getTraversalMode());
	...
	@Override
	public TraverseByEntityProperty read(Kryo kryo, Input input, Class<? extends TraverseByEntityProperty> type) {
		final TraversalMode traversalMode = kryo.readObject(input, TraversalMode.class);
