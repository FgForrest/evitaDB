...
/**
 * This {@link Serializer} implementation reads/writes {@link AttributeHistogram} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class AttributeHistogramSerializer extends Serializer<AttributeHistogram> {
