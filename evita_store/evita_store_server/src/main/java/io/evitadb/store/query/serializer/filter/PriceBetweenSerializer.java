...
/**
 * This {@link Serializer} implementation reads/writes {@link PriceBetween} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class PriceBetweenSerializer extends Serializer<PriceBetween> {
