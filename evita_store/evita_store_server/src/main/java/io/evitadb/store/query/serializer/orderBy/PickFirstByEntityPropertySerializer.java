...
/**
 * This {@link Serializer} implementation reads/writes {@link PickFirstByEntityProperty} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2025
 */
@RequiredArgsConstructor
public class PickFirstByEntityPropertySerializer extends Serializer<PickFirstByEntityProperty> {

	@Override
	public void write(Kryo kryo, Output output, PickFirstByEntityProperty object) {
	...
	@Override
	public PickFirstByEntityProperty read(Kryo kryo, Input input, Class<? extends PickFirstByEntityProperty> type) {
