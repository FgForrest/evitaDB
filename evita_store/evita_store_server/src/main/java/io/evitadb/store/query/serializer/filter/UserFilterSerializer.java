...
/**
 * This {@link Serializer} implementation reads/writes {@link UserFilter} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class UserFilterSerializer extends Serializer<UserFilter> {

	@Override
	public void write(Kryo kryo, Output output, UserFilter object) {
	...
	@Override
	public UserFilter read(Kryo kryo, Input input, Class<? extends UserFilter> type) {
