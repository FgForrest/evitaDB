...
/**
 * This {@link Serializer} implementation reads/writes {@link HierarchyOfSelf} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class HierarchyOfSelfSerializer extends Serializer<HierarchyOfSelf> {

	@Override
	public void write(Kryo kryo, Output output, HierarchyOfSelf object) {
	...
	@Override
	public HierarchyOfSelf read(Kryo kryo, Input input, Class<? extends HierarchyOfSelf> type) {
		...
		final OrderBy orderConstraint = kryo.readObjectOrNull(input, OrderBy.class);
