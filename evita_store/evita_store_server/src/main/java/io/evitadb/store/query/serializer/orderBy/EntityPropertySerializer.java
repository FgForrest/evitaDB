...
/**
 * This {@link Serializer} implementation reads/writes {@link EntityProperty} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class EntityPropertySerializer extends Serializer<EntityProperty> {

	@Override
	public void write(Kryo kryo, Output output, EntityProperty object) {
	...
	@Override
	public EntityProperty read(Kryo kryo, Input input, Class<? extends EntityProperty> type) {
