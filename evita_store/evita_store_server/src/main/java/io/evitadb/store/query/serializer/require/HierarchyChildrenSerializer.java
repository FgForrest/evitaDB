...
/**
 * This {@link Serializer} implementation reads/writes {@link HierarchyChildren} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class HierarchyChildrenSerializer extends Serializer<HierarchyChildren> {

	@Override
	public void write(Kryo kryo, Output output, HierarchyChildren object) {
	...
	@Override
	public HierarchyChildren read(Kryo kryo, Input input, Class<? extends HierarchyChildren> type) {
		...
		return new HierarchyChildren(outputName, entityFetch, stopAt, statistics);
	}
