...
/**
 * This {@link Serializer} implementation reads/writes {@link And} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class AndSerializer extends Serializer<And> {

	@Override
	public void write(Kryo kryo, Output output, And object) {
	...
	@Override
	public And read(Kryo kryo, Input input, Class<? extends And> type) {
