...
/**
 * Backward-compatible reader for {@link CreateGlobalAttributeSchemaMutation} serialized in the `2026.1` format, before
 * the conflict resolution override field was added. It reconstructs the mutation defaulting the override to
