 ...
 */
public class InsertReferenceMutationSerializer  extends Serializer<InsertReferenceMutation> {
	...
	public void write(Kryo kryo, Output output, InsertReferenceMutation mutation) {
		...
		kryo.writeObjectOrNull(output, mutation.getReferenceCardinality(), Cardinality.class);
