...
package io.evitadb.store.shared.kryo;
...
import io.evitadb.store.shared.serializer.complexData.DataItemArraySerializer;
import io.evitadb.store.shared.serializer.complexData.DataItemMapSerializer;
import io.evitadb.store.shared.serializer.complexData.DataItemValueSerializer;
import io.evitadb.store.shared.serializer.dataType.*;
import io.evitadb.store.shared.serializer.dataType.EnumSetSerializer;
import io.evitadb.store.shared.serializer.trie.TrieNodeSerializer;
...
public class KryoFactory {
	...
	public static <T extends Kryo> T initializeKryo(@Nonnull T kryoInstance) {
		...
		kryoInstance.register(Set.class, new SetSerializer<>(HashSet::newHashSet), index++);
		kryoInstance.register(HashSet.class, new SetSerializer<>(HashSet::newHashSet), index++);
		kryoInstance.register(LinkedHashSet.class, new SetSerializer<>(LinkedHashSet::newLinkedHashSet), index++);
		kryoInstance.register(Map.class, new MapSerializer<>(HashMap::newHashMap), index++);
		kryoInstance.register(HashMap.class, new MapSerializer<>(HashMap::newHashMap), index++);
		kryoInstance.register(LinkedHashMap.class, new MapSerializer<>(LinkedHashMap::newLinkedHashMap), index++);
