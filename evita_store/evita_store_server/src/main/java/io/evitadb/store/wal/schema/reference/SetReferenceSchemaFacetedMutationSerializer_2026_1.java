...
/**
 * Backward-compatible serializer for {@link SetReferenceSchemaFacetedMutation}
 * before `facetedPartiallyInScopes` field was added (pre-2026.1).
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@Deprecated(since = "2026.1", forRemoval = true)
public class SetReferenceSchemaFacetedMutationSerializer_2026_1 extends Serializer<SetReferenceSchemaFacetedMutation> implements MutationSerializationFunctions {
