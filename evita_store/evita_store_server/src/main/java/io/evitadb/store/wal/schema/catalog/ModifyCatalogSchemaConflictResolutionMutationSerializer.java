...
/**
 * Serializer for {@link ModifyCatalogSchemaConflictResolutionMutation}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2026
 */
public class ModifyCatalogSchemaConflictResolutionMutationSerializer
	extends Serializer<ModifyCatalogSchemaConflictResolutionMutation> {

	@Override
	public void write(Kryo kryo, Output output, ModifyCatalogSchemaConflictResolutionMutation mutation) {
	...
	@Override
	public ModifyCatalogSchemaConflictResolutionMutation read(
		Kryo kryo, Input input, Class<? extends ModifyCatalogSchemaConflictResolutionMutation> type
	) {
