...
public class OrSerializer extends Serializer<Or> {

	@Override
	public void write(Kryo kryo, Output output, Or object) {
	...
	@Override
	public Or read(Kryo kryo, Input input, Class<? extends Or> type) {
