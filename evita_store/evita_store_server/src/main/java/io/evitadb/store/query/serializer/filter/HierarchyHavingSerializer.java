...
/**
 * This {@link Serializer} implementation reads/writes {@link HierarchyHaving} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class HierarchyHavingSerializer extends Serializer<HierarchyHaving> {

	@Override
	public void write(Kryo kryo, Output output, HierarchyHaving object) {
	...
	@Override
	public HierarchyHaving read(Kryo kryo, Input input, Class<? extends HierarchyHaving> type) {
