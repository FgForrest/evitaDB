...
/**
 * This {@link Serializer} implementation reads/writes {@link EntityFetch} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class EntityFetchSerializer extends Serializer<EntityFetch> {

	@Override
	public void write(Kryo kryo, Output output, EntityFetch object) {
	...
	@Override
	public EntityFetch read(Kryo kryo, Input input, Class<? extends EntityFetch> type) {
