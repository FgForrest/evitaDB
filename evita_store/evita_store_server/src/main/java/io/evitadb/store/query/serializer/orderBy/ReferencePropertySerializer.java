...
/**
 * This {@link Serializer} implementation reads/writes {@link ReferenceProperty} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class ReferencePropertySerializer extends Serializer<ReferenceProperty> {

	@Override
	public void write(Kryo kryo, Output output, ReferenceProperty object) {
	...
	@Override
	public ReferenceProperty read(Kryo kryo, Input input, Class<? extends ReferenceProperty> type) {
