...
class ModifyAttributeSchemaDeprecationNoticeMutationConverterTest {
	...
	private static ModifyAttributeSchemaDeprecationNoticeMutationConverter converter;
	...
	void shouldConvertMutation() {
		final ModifyAttributeSchemaDeprecationNoticeMutation mutation1 = new ModifyAttributeSchemaDeprecationNoticeMutation(
			"code", "depr"
		);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final ModifyAttributeSchemaDeprecationNoticeMutation mutation2 = new ModifyAttributeSchemaDeprecationNoticeMutation(
			"code", null
		);
