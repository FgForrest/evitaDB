...
class SetPriceInnerRecordHandlingMutationConverterTest {
	...
	private static SetPriceInnerRecordHandlingMutationConverter converter;
	...
	void shouldConvertMutation() {
		final SetPriceInnerRecordHandlingMutation mutation1 = new SetPriceInnerRecordHandlingMutation(PriceInnerRecordHandling.SUM);
