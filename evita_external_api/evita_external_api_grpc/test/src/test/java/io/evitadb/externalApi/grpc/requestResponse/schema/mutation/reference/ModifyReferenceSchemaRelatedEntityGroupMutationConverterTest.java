...
class ModifyReferenceSchemaRelatedEntityGroupMutationConverterTest {
	...
	private static ModifyReferenceSchemaRelatedEntityGroupMutationConverter converter;
	...
	void shouldConvertMutation() {
		final ModifyReferenceSchemaRelatedEntityGroupMutation mutation1 = new ModifyReferenceSchemaRelatedEntityGroupMutation(
			"tags",
			"tagGroup",
			false
		);
		...
		final ModifyReferenceSchemaRelatedEntityGroupMutation mutation2 = new ModifyReferenceSchemaRelatedEntityGroupMutation(
			"tags",
			null,
			false
		);
