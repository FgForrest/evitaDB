...
/**
 * Converts between {@link SetAttributeSchemaNullableMutation} and {@link GrpcSetAttributeSchemaNullableMutation} in both directions.
 *
...
public class SetAttributeSchemaNullableMutationConverter implements SchemaMutationConverter<SetAttributeSchemaNullableMutation, GrpcSetAttributeSchemaNullableMutation> {
	...
	@Nonnull
	public GrpcSetAttributeSchemaNullableMutation convert(@Nonnull SetAttributeSchemaNullableMutation mutation) {
		return GrpcSetAttributeSchemaNullableMutation.newBuilder()
