...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 16: {
            ...
            this.entityPrimaryKey_ = input.readInt32();
            break;
          }
          default: {
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (this.entityPrimaryKey_ != 0) {
      output.writeInt32(2, this.entityPrimaryKey_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (this.entityPrimaryKey_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt32Size(2, this.entityPrimaryKey_);
    }
