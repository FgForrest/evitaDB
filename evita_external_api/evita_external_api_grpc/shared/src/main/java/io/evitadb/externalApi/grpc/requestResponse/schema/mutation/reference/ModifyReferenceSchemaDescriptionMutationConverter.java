...
/**
 * Converts between {@link ModifyReferenceSchemaDescriptionMutation} and {@link GrpcModifyReferenceSchemaDescriptionMutation} in both directions.
 *
...
public class ModifyReferenceSchemaDescriptionMutationConverter implements SchemaMutationConverter<ModifyReferenceSchemaDescriptionMutation, GrpcModifyReferenceSchemaDescriptionMutation> {
	...
	@Nonnull
	public GrpcModifyReferenceSchemaDescriptionMutation convert(@Nonnull ModifyReferenceSchemaDescriptionMutation mutation) {
		final GrpcModifyReferenceSchemaDescriptionMutation.Builder builder = GrpcModifyReferenceSchemaDescriptionMutation.newBuilder()
