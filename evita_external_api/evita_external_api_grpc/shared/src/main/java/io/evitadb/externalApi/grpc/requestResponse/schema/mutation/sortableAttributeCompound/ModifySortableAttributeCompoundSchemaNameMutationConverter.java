...
/**
 * Converts between {@link ModifySortableAttributeCompoundSchemaNameMutation} and {@link GrpcModifySortableAttributeCompoundSchemaNameMutation} in both directions.
 *
...
public class ModifySortableAttributeCompoundSchemaNameMutationConverter implements SchemaMutationConverter<ModifySortableAttributeCompoundSchemaNameMutation, GrpcModifySortableAttributeCompoundSchemaNameMutation> {
	...
	@Nonnull
	public GrpcModifySortableAttributeCompoundSchemaNameMutation convert(@Nonnull ModifySortableAttributeCompoundSchemaNameMutation mutation) {
		final GrpcModifySortableAttributeCompoundSchemaNameMutation.Builder builder = GrpcModifySortableAttributeCompoundSchemaNameMutation.newBuilder()
