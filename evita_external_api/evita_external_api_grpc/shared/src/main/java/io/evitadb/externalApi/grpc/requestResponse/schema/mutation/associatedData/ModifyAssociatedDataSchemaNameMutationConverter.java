...
/**
 * Converts between {@link ModifyAssociatedDataSchemaNameMutation} and {@link GrpcModifyAssociatedDataSchemaNameMutation} in both directions.
 *
...
public class ModifyAssociatedDataSchemaNameMutationConverter implements SchemaMutationConverter<ModifyAssociatedDataSchemaNameMutation, GrpcModifyAssociatedDataSchemaNameMutation> {
	...
	@Nonnull
	public GrpcModifyAssociatedDataSchemaNameMutation convert(@Nonnull ModifyAssociatedDataSchemaNameMutation mutation) {
		return GrpcModifyAssociatedDataSchemaNameMutation.newBuilder()
