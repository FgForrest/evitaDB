...
/**
 * Converts between {@link RemoveReferenceSchemaMutation} and {@link GrpcRemoveReferenceSchemaMutation} in both directions.
 *
...
public class RemoveReferenceSchemaMutationConverter implements SchemaMutationConverter<RemoveReferenceSchemaMutation, GrpcRemoveReferenceSchemaMutation> {
	...
	@Nonnull
	public GrpcRemoveReferenceSchemaMutation convert(@Nonnull RemoveReferenceSchemaMutation mutation) {
		return GrpcRemoveReferenceSchemaMutation.newBuilder()
