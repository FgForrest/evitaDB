...
private static final long serialVersionUID = 0L;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (this.uniqueGlobally_ != io.evitadb.externalApi.grpc.generated.GrpcGlobalAttributeUniquenessType.NOT_GLOBALLY_UNIQUE.getNumber()) {
      output.writeEnum(13, this.uniqueGlobally_);
    }
    for (int i = 0; i < this.nameVariant_.size(); i++) {
      output.writeMessage(14, this.nameVariant_.get(i));
    }
    for (int i = 0; i < this.uniqueInScopes_.size(); i++) {
      output.writeMessage(15, this.uniqueInScopes_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (this.uniqueGlobally_ != io.evitadb.externalApi.grpc.generated.GrpcGlobalAttributeUniquenessType.NOT_GLOBALLY_UNIQUE.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(13, this.uniqueGlobally_);
    }
    for (int i = 0; i < this.nameVariant_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(14, this.nameVariant_.get(i));
    }
    for (int i = 0; i < this.uniqueInScopes_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(15, this.uniqueInScopes_.get(i));
    }
    {
      int dataSize = 0;
      for (int i = 0; i < this.filterableInScopes_.size(); i++) {
