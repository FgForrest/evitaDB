...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              this.value_ = new java.util.ArrayList<io.evitadb.externalApi.grpc.generated.GrpcBigDecimal>();
  ...
  public static final class Builder extends
    ...
    private void ensureValueIsMutable() {
      if (!((this.bitField0_ & 0x00000001) != 0)) {
        this.value_ = new java.util.ArrayList<io.evitadb.externalApi.grpc.generated.GrpcBigDecimal>(this.value_);
