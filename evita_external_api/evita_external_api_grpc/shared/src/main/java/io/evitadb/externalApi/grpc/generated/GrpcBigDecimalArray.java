...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(io.evitadb.externalApi.grpc.generated.GrpcBigDecimalArray result) {
      if (valueBuilder_ == null) {
    ...
    private void buildPartial0(io.evitadb.externalApi.grpc.generated.GrpcBigDecimalArray result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              io.evitadb.externalApi.grpc.generated.GrpcBigDecimal m =
                  input.readMessage(
                      io.evitadb.externalApi.grpc.generated.GrpcBigDecimal.parser(),
                      extensionRegistry);
              if (valueBuilder_ == null) {
                ensureValueIsMutable();
                value_.add(m);
