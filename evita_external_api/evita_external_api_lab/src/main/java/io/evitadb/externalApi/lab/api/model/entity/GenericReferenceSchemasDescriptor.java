...
/**
 * Generic equivalent of {@link ReferenceSchemasDescriptor}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface GenericReferenceSchemasDescriptor extends ReferenceSchemasDescriptor {

	ObjectDescriptor THIS = ObjectDescriptor.extend(ReferenceSchemasDescriptor.THIS)
		.name("ReferenceSchemas")
		.build();
}
