...
/**
 * Single REST endpoint with schema description and handler builder for building schema endpoints.
 ...
 */
public class OpenApiLabApiSchemaEndpoint extends OpenApiEndpoint<LabRestHandlingContext> {

	private OpenApiLabApiSchemaEndpoint(@Nonnull PathItem.HttpMethod method,
	...
	/**
	 * Creates builder for new lab schema endpoint.
	 */
	@Nonnull
	public static Builder newLabSchemaEndpoint() {
		return new Builder();
	}
	...
	public static class Builder {
		...
		/**
		 * Set path of this endpoint. Provided builder is already configured with schema prefix
		 * `/lab/schema`.
		 */
		@Nonnull
		public Builder path(@Nonnull UnaryOperator<PathBuilder> pathBuilderFunction) {
			// prepare new schema path
		...
		@Nonnull
		public OpenApiLabApiSchemaEndpoint build() {
			Assert.isPremiseValid(
				path != null,
			...
			return new OpenApiLabApiSchemaEndpoint(
				method,
				path,
				operationId,
				description,
