...
/**
 * Generic equivalent of {@link AssociatedDataSchemasDescriptor}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface GenericAssociatedDataSchemasDescriptor extends AssociatedDataSchemasDescriptor {

	ObjectDescriptor THIS = ObjectDescriptor.extend(AssociatedDataSchemasDescriptor.THIS)
		.name("AssociatedDataSchemas")
		.build();
}
