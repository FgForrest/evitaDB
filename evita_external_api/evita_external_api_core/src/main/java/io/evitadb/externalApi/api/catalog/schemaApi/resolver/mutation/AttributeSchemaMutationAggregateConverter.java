...
import static io.evitadb.externalApi.api.catalog.schemaApi.model.mutation.AttributeSchemaMutationAggregateDescriptor.*;
...
public class AttributeSchemaMutationAggregateConverter extends MutationAggregateConverter<AttributeSchemaMutation, AttributeSchemaMutationConverter<AttributeSchemaMutation>> {
	...
	protected String getMutationAggregateName() {
		return AttributeSchemaMutationAggregateDescriptor.THIS.name();
	}
}
