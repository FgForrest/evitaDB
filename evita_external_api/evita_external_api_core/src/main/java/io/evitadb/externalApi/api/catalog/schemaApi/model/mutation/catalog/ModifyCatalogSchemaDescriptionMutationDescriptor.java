...
/**
 * Descriptor representing {@link io.evitadb.api.requestResponse.schema.mutation.catalog.ModifyCatalogSchemaDescriptionMutation}.
 *
 * Note: this descriptor has static structure.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface ModifyCatalogSchemaDescriptionMutationDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.builder()
		...
		.description("""
			...
			in `CatalogSchema`.
			""")
		.staticFields(List.of(DESCRIPTION))
		.build();
}
