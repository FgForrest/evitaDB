...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link DisallowEvolutionModeInEntitySchemaMutation}.
 *
...
public class DisallowEvolutionModeInEntitySchemaMutationConverter extends EntitySchemaMutationConverter<DisallowEvolutionModeInEntitySchemaMutation> {
	...
	@Nonnull
	@Override
	protected DisallowEvolutionModeInEntitySchemaMutation convert(@Nonnull InputMutation inputMutation) {
		return new DisallowEvolutionModeInEntitySchemaMutation(
			(EvolutionMode[]) inputMutation.getRequiredField(DisallowEvolutionModeInEntitySchemaMutationDescriptor.EVOLUTION_MODES)
		);
	}
}
