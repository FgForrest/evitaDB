...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link ModifySortableAttributeCompoundSchemaDescriptionMutation}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public class ModifySortableAttributeCompoundSchemaDescriptionMutationConverter extends SortableAttributeCompoundSchemaMutationConverter<ModifySortableAttributeCompoundSchemaDescriptionMutation> {

	public ModifySortableAttributeCompoundSchemaDescriptionMutationConverter(@Nonnull MutationObjectParser objectParser,
	...
	@Nonnull
	@Override
	protected ModifySortableAttributeCompoundSchemaDescriptionMutation convert(@Nonnull InputMutation inputMutation) {
		return new ModifySortableAttributeCompoundSchemaDescriptionMutation(
			...
			inputMutation.getOptionalField(ModifySortableAttributeCompoundSchemaDescriptionMutationDescriptor.DESCRIPTION)
		);
	}
}
