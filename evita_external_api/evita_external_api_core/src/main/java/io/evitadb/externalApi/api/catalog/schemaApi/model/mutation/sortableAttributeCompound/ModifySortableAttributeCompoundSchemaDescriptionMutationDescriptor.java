...
/**
 * Descriptor representing {@link ModifySortableAttributeCompoundSchemaDescriptionMutation}.
 *
 * Note: this descriptor has static structure.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface ModifySortableAttributeCompoundSchemaDescriptionMutationDescriptor extends SortableAttributeCompoundSchemaMutationDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.implementing(THIS_INTERFACE)
		.representedClass(ModifySortableAttributeCompoundSchemaDescriptionMutation.class)
		.description("""
			Mutation is responsible for setting value to a `SortableAttributeCompoundSchema.description`
