...
/**
 * Union descriptor for all possible types of mutations for attribute data modification.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2025
 */
public interface AttributeMutationUnionDescriptor {

	UnionDescriptor THIS = UnionDescriptor.builder()
		.name("AttributeMutationUnion")
		.description("Lists all possible mutations of the attribute")
