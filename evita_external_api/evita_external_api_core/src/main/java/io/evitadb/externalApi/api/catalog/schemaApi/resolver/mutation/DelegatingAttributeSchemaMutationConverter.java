...
/**
 * Implementation of {@link DelegatingMutationConverter} for converting implementations of {@link AttributeSchemaMutation}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public class DelegatingAttributeSchemaMutationConverter extends
	DelegatingMutationConverter<AttributeSchemaMutation, AttributeSchemaMutationConverter<AttributeSchemaMutation>> {

	@Nonnull
	@Getter(AccessLevel.PROTECTED)
	private final Map<Class<? extends AttributeSchemaMutation>, AttributeSchemaMutationConverter<AttributeSchemaMutation>> converters = createHashMap(15);

	public DelegatingAttributeSchemaMutationConverter(
		@Nonnull MutationObjectMapper objectParser,
		@Nonnull MutationResolvingExceptionFactory exceptionFactory
	) {
		super(objectParser, exceptionFactory);

		registerConverter(CreateAttributeSchemaMutation.class, new CreateAttributeSchemaMutationConverter(objectParser, exceptionFactory));
	...
	protected String getAncestorMutationName() {
		return AttributeSchemaMutation.class.getSimpleName();
	}
}
