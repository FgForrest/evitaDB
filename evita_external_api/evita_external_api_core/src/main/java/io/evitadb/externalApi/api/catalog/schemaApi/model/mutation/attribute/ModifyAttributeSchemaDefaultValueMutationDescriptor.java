...
/**
 * Descriptor representing {@link io.evitadb.api.requestResponse.schema.mutation.attribute.ModifyAttributeSchemaDefaultValueMutation}.
 *
 * Note: this descriptor has static structure.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface ModifyAttributeSchemaDefaultValueMutationDescriptor extends AttributeSchemaMutationDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.builder()
		...
		.description("""
			...
			""")
		.staticFields(List.of(NAME, DEFAULT_VALUE))
		.build();
}
