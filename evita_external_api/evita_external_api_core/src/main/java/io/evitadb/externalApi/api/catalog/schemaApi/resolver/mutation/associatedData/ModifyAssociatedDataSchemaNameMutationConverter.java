...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link ModifyAssociatedDataSchemaNameMutation}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public class ModifyAssociatedDataSchemaNameMutationConverter extends AssociatedDataSchemaMutationConverter<ModifyAssociatedDataSchemaNameMutation> {

	public ModifyAssociatedDataSchemaNameMutationConverter(@Nonnull MutationObjectParser objectParser,
	...
	protected String getMutationName() {
		return ModifyAssociatedDataSchemaNameMutationDescriptor.THIS.name();
	}

	@Nonnull
	@Override
	protected ModifyAssociatedDataSchemaNameMutation convert(@Nonnull InputMutation inputMutation) {
		return new ModifyAssociatedDataSchemaNameMutation(
			...
			inputMutation.getRequiredField(ModifyAssociatedDataSchemaNameMutationDescriptor.NEW_NAME)
		);
	}
}
