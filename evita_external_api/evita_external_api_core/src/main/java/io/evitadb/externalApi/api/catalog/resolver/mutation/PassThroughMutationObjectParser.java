...
/**
 * Implementation of {@link MutationObjectParser} which doesn't do any parsing, just passes input data through.
 * This expects that input data are correctly converted to data expected by {@link MutationConverter}s.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
public class PassThroughMutationObjectParser implements MutationObjectParser {
