 ...
 */
public interface RemoveReferenceSchemaMutationDescriptor extends ReferenceSchemaMutationDescriptor {

	ObjectDescriptor THIS = ObjectDescriptor.implementing(THIS_INTERFACE)
		.representedClass(RemoveReferenceSchemaMutation.class)
		.description("""
			Mutation is responsible for removing an existing `ReferenceSchema` in the
			`EntitySchema`.
