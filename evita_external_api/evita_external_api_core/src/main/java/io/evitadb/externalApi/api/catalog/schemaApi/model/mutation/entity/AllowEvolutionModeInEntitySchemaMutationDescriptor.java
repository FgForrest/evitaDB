...
/**
 * Descriptor representing {@link io.evitadb.api.requestResponse.schema.mutation.entity.AllowEvolutionModeInEntitySchemaMutation}.
 *
 * Note: this descriptor has static structure.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface AllowEvolutionModeInEntitySchemaMutationDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.builder()
		...
		.description("""
			Mutation is responsible for adding one or more currencies to a `EntitySchema.evolutionMode`
			in `EntitySchema`.
			""")
