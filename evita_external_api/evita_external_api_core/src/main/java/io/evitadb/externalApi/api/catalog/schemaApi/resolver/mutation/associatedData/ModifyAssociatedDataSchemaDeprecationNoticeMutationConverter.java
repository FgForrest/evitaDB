...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link ModifyAssociatedDataSchemaDeprecationNoticeMutation}.
 *
...
public class ModifyAssociatedDataSchemaDeprecationNoticeMutationConverter extends AssociatedDataSchemaMutationConverter<ModifyAssociatedDataSchemaDeprecationNoticeMutation> {
	...
	@Nonnull
	@Override
	protected ModifyAssociatedDataSchemaDeprecationNoticeMutation convert(@Nonnull InputMutation inputMutation) {
		return new ModifyAssociatedDataSchemaDeprecationNoticeMutation(
			...
			inputMutation.getOptionalField(ModifyAssociatedDataSchemaDeprecationNoticeMutationDescriptor.DEPRECATION_NOTICE)
		);
	}
}
