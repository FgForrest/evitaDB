...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link ModifyEntitySchemaConflictResolutionMutation}.
 *
 ...
 */
public class ModifyEntitySchemaConflictResolutionMutationConverter
	extends EntitySchemaMutationConverter<ModifyEntitySchemaConflictResolutionMutation> {

	public ModifyEntitySchemaConflictResolutionMutationConverter(
	...
	@Nonnull
	@Override
	protected Class<ModifyEntitySchemaConflictResolutionMutation> getMutationClass() {
		return ModifyEntitySchemaConflictResolutionMutation.class;
	}

	@Nonnull
	@Override
	protected ModifyEntitySchemaConflictResolutionMutation convertFromInput(@Nonnull Input input) {
		final ConflictResolution conflictResolution = input.getOptionalProperty(
			ModifyEntitySchemaConflictResolutionMutationDescriptor.CONFLICT_RESOLUTION.name(),
	...
	protected void convertToOutput(
		@Nonnull ModifyEntitySchemaConflictResolutionMutation mutation,
