...
/**
 * Ancestor descriptor of root for schema-based external APIs.
 *
...
public interface CatalogRootDescriptor {
    ...
    ObjectDescriptor SCALAR_ENUM = ObjectDescriptor.builder()
        ...
        .description("""
            ...
            """)
        .build();
    ObjectDescriptor ASSOCIATED_DATA_SCALAR_ENUM = ObjectDescriptor.builder()
        .name("AssociatedDataScalar")
        .description("""
