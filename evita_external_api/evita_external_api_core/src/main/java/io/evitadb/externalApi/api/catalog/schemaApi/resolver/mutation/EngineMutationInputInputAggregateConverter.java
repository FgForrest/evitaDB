...
import static io.evitadb.externalApi.api.catalog.schemaApi.model.mutation.EngineMutationInputAggregateDescriptor.*;
 ...
 */
public class EngineMutationInputInputAggregateConverter
	extends MutationInputAggregateConverter<EngineMutation<?>, EngineMutationConverter<EngineMutation<?>>> {

	@Nonnull
	@Getter(AccessLevel.PROTECTED)
	private final Map<String, EngineMutationConverter<EngineMutation<?>>> converters = createHashMap(5);

	public EngineMutationInputInputAggregateConverter(
	...
	protected String getMutationAggregateName() {
		return EngineMutationInputAggregateDescriptor.THIS_INPUT.name();
	}
}
