...
/**
 * Implementation of {@link LocalMutationConverter} for resolving {@link RemoveReferenceMutation}.
 *
...
public class RemoveReferenceMutationConverter extends ReferenceMutationConverter<RemoveReferenceMutation> {
	...
	@Nonnull
	@Override
	protected RemoveReferenceMutation convert(@Nonnull InputMutation inputMutation) {
		return new RemoveReferenceMutation(resolveReferenceKey(inputMutation));
	}
}
