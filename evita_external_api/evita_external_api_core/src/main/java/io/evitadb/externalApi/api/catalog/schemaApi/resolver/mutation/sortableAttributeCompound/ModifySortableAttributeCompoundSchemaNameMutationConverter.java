...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link ModifySortableAttributeCompoundSchemaNameMutation}.
 *
...
public class ModifySortableAttributeCompoundSchemaNameMutationConverter extends SortableAttributeCompoundSchemaMutationConverter<ModifySortableAttributeCompoundSchemaNameMutation> {
	...
	@Nonnull
	@Override
	protected ModifySortableAttributeCompoundSchemaNameMutation convert(@Nonnull InputMutation inputMutation) {
		return new ModifySortableAttributeCompoundSchemaNameMutation(
			...
			inputMutation.getRequiredField(ModifySortableAttributeCompoundSchemaNameMutationDescriptor.NEW_NAME)
		);
	}
}
