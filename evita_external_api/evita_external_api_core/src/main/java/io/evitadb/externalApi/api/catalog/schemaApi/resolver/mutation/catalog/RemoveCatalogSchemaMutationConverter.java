...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link RemoveCatalogSchemaMutation}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public class RemoveCatalogSchemaMutationConverter extends CatalogSchemaMutationConverter<RemoveCatalogSchemaMutation> {
	...
	@Nonnull
	@Override
	protected RemoveCatalogSchemaMutation convert(@Nonnull InputMutation inputMutation) {
		return new RemoveCatalogSchemaMutation(
			inputMutation.getRequiredField(TopLevelCatalogSchemaMutationDescriptor.CATALOG_NAME)
		);
	}
}
