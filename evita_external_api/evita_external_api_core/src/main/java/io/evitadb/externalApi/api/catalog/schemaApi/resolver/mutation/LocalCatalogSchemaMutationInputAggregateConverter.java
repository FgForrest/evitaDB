...
import static io.evitadb.externalApi.api.catalog.schemaApi.model.mutation.LocalCatalogSchemaMutationInputAggregateDescriptor.*;
import static io.evitadb.utils.CollectionUtils.createHashMap;

/**
 * Implementation of {@link MutationInputAggregateConverter} for converting aggregates of {@link LocalCatalogSchemaMutation}s.
 * into list of individual mutations.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public class LocalCatalogSchemaMutationInputAggregateConverter extends
	MutationInputAggregateConverter<LocalCatalogSchemaMutation, SchemaMutationConverter<LocalCatalogSchemaMutation>> {

	@Nonnull
	@Getter(AccessLevel.PROTECTED)
	private final Map<String, SchemaMutationConverter<LocalCatalogSchemaMutation>> converters = createHashMap(20);

	public LocalCatalogSchemaMutationInputAggregateConverter(@Nonnull MutationObjectMapper objectParser,
	...
	protected String getMutationAggregateName() {
		return LocalCatalogSchemaMutationInputAggregateDescriptor.THIS_INPUT.name();
	}
}
