...
/**
 * Describes a strip list of {@link ReferenceDescriptor#THIS_INTERFACE}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2026
 */
public interface ReferenceStripDescriptor extends StripListDescriptor {

	PropertyDescriptor DATA = PropertyDescriptor.from(StripListDescriptor.DATA)
	...
	ObjectDescriptor THIS_INTERFACE = ObjectDescriptor.implementing(StripListDescriptor.THIS_INTERFACE)
		.name("ReferenceStrip")
		.description("Strip of references according to offset and limit rules in input query.")
		.staticProperty(DATA)
		.build();
}
