...
/**
 * Descriptor representing {@link io.evitadb.api.requestResponse.schema.mutation.catalog.RemoveEntitySchemaMutation}.
 *
 * Note: this descriptor has static structure.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface RemoveEntitySchemaMutationDescriptor extends MutationDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.implementing(THIS_INTERFACE)
		.representedClass(RemoveEntitySchemaMutation.class)
		.description("""
