...
/**
 * Implementation of {@link MutationAggregateConverter} for converting aggregates of infrastructure mutations into
 * a list of individual mutations.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2025
 */
public class InfrastructureMutationAggregateConverter extends MutationAggregateConverter<Mutation, MutationConverter<Mutation>> {
	...
	protected String getMutationAggregateName() {
		return InfrastructureMutationAggregateDescriptor.THIS.name();
	}
}
