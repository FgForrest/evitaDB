...
/**
 * Descriptor representing {@link io.evitadb.api.requestResponse.schema.mutation.entity.ModifyEntitySchemaDeprecationNoticeMutation}.
 *
...
public interface ModifyEntitySchemaDeprecationNoticeMutationDescriptor extends EntitySchemaMutationDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.builder()
		.name("ModifyEntitySchemaDeprecationNoticeMutation")
		.description("""
			Mutation is responsible for setting a `EntitySchema.deprecationNotice`
			in `EntitySchema`.
			""")
		.staticProperties(List.of(MUTATION_TYPE, DEPRECATION_NOTICE))
		.build();
	ObjectDescriptor THIS_INPUT = ObjectDescriptor.from(THIS)
		.name("ModifyEntitySchemaDeprecationNoticeMutationInput")
		.staticProperties(List.of(DEPRECATION_NOTICE))
		.build();
}
