...
public class ModifyReferenceSchemaRelatedEntityMutationConverter extends ReferenceSchemaMutationConverter<ModifyReferenceSchemaRelatedEntityMutation> {
	...
	@Nonnull
	@Override
	protected ModifyReferenceSchemaRelatedEntityMutation convert(@Nonnull InputMutation inputMutation) {
		return new ModifyReferenceSchemaRelatedEntityMutation(
			...
			inputMutation.getRequiredField(ModifyReferenceSchemaRelatedEntityMutationDescriptor.REFERENCED_ENTITY_TYPE),
			inputMutation.getRequiredField(ModifyReferenceSchemaRelatedEntityMutationDescriptor.REFERENCED_ENTITY_TYPE_MANAGED)
		);
	}
}
