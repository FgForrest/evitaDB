...
public class SetAttributeSchemaGloballyUniqueMutationConverter extends AttributeSchemaMutationConverter<SetAttributeSchemaGloballyUniqueMutation> {
	...
	@Nonnull
	@Override
	protected SetAttributeSchemaGloballyUniqueMutation convert(@Nonnull InputMutation inputMutation) {
		return new SetAttributeSchemaGloballyUniqueMutation(
			inputMutation.getRequiredField(AttributeSchemaMutationDescriptor.NAME),
			inputMutation.getRequiredField(SetAttributeSchemaGloballyUniqueMutationDescriptor.UNIQUE_GLOBALLY)
		);
	}
}
