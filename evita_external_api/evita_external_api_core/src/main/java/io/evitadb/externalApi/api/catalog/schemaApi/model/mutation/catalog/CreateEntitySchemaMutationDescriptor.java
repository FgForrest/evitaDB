...
/**
 * Descriptor representing {@link io.evitadb.api.requestResponse.schema.mutation.catalog.CreateEntitySchemaMutation}.
 *
 * Note: this descriptor has static structure.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public interface CreateEntitySchemaMutationDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.builder()
		...
		.description("""
			...
			""")
		.staticFields(List.of(ENTITY_TYPE))
		.build();
}
