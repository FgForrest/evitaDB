...
/**
 * Represents {@link io.evitadb.api.requestResponse.extraResult.ReferenceSummary}.
 *
 ...
 */
public interface ReferenceSummaryDescriptor {
	...
	ObjectDescriptor THIS = ObjectDescriptor.builder()
		...
		.description("""
			...
			DTO contains information about reference groups and individual references in them as well as appropriate statistics for them.
			""")
		.build();

	/**
	 * Represents {@link io.evitadb.api.requestResponse.extraResult.ReferenceSummary.ReferenceGroupStatistics}.
	 *
	 * Note: this descriptor is meant be template for generated specific DTOs base on internal data. Fields in this
	 * descriptor are supposed to be dynamically registered to target generated DTO.
	 */
	interface ReferenceGroupStatisticsDescriptor {
	...
	/**
	 * Represents {@link io.evitadb.api.requestResponse.extraResult.ReferenceSummary.FacetStatistics}.
	 *
	 * Note: this descriptor is meant be template for generated specific DTOs base on internal data. Fields in this
	 * descriptor are supposed to be dynamically registered to target generated DTO.
	 */
	...
	/**
	 * Represents {@link io.evitadb.api.requestResponse.extraResult.ReferenceSummary.RequestImpact}.
	 *
