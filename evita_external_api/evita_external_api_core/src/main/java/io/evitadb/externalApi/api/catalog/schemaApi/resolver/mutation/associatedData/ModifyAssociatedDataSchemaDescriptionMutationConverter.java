...
/**
 * Implementation of {@link SchemaMutationConverter} for resolving {@link ModifyAssociatedDataSchemaDescriptionMutation}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public class ModifyAssociatedDataSchemaDescriptionMutationConverter extends AssociatedDataSchemaMutationConverter<ModifyAssociatedDataSchemaDescriptionMutation> {

	public ModifyAssociatedDataSchemaDescriptionMutationConverter(@Nonnull MutationObjectParser objectParser,
	...
	@Nonnull
	@Override
	protected ModifyAssociatedDataSchemaDescriptionMutation convert(@Nonnull InputMutation inputMutation) {
		return new ModifyAssociatedDataSchemaDescriptionMutation(
			...
			inputMutation.getOptionalField(ModifyAssociatedDataSchemaDescriptionMutationDescriptor.DESCRIPTION)
		);
	}
}
