...
/**
 * Union descriptor of all possible types of schema mutations for reference sortable attribute compound schema modification.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2025
 */
public interface ReferenceSortableAttributeCompoundSchemaMutationUnionDescriptor {

	UnionDescriptor THIS = UnionDescriptor.builder()
		.name("ReferenceSortableAttributeCompoundSchemaMutationUnion")
		.description("Lists all possible types of schema mutations for reference sortable attribute compound schema modification.")
