...
/**
 * Static descriptor of {@link io.evitadb.api.requestResponse.cdc.DataSite}
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2025
 */
public interface DataSiteDescriptor {
	...
	PropertyDescriptor ENTITY_PRIMARY_KEY = PropertyDescriptor.builder()
		...
		.description("The primary key of intercepted entity")
