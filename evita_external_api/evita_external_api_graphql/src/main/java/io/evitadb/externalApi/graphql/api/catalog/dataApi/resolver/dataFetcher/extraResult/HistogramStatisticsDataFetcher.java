...
/**
 * Extracts single named {@link HistogramContract} from the {@link ReferenceGroupStatistics} source object
 * produced by a parent reference summary field.
 *
...
public class HistogramStatisticsDataFetcher implements DataFetcher<HistogramContract> {
	...
	/**
	 * Name of the histogram index to extract from the parent {@link ReferenceGroupStatistics}.
	 */
	...
	public HistogramContract get(DataFetchingEnvironment environment) throws Exception {
		...
		return stats.getHistogramStatistics(this.histogramIndexName);
	}
}
