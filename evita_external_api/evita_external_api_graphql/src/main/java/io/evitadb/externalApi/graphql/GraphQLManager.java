...
import io.evitadb.externalApi.graphql.metric.event.schema.BuiltEvent.BuildType;
...
public class GraphQLManager {
	...
	private void registerSystemApi() {
		...
		systemBuildStatistics = SystemBuildStatistics.createNew(
			System.currentTimeMillis() - schemaBuildStartTime,
	...
	private record SystemBuildStatistics(@Nonnull AtomicBoolean reported,
		...
		public static SystemBuildStatistics createNew(long schemaBuildDuration,
		                                              long schemaDslLines) {
	...
	private record CatalogBuildStatistics(@Nonnull AtomicInteger buildCount,
		...
		public static CatalogBuildStatistics createNew(long dataApiSchemaBuildDuration,
		...
		public void refresh(long dataApiSchemaBuildDuration,
		                    long dataApiSchemaDslLines,
		                    long schemaApiSchemaBuildDuration,
		                    long schemaApiSchemaDslLines) {
