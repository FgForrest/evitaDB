...
public class ReferenceWithReferencedEntityInterfaceBuilder {
	...
	@Nonnull
	public GraphQLInterfaceType build(@Nonnull ReferenceSchemaContract referenceSchema) {
		...
		return this.buildingContext.getOrComputeReferenceWithReferencedEntityInterface(
			...
			() -> {
				...
				final GraphQLInterfaceType referenceInterfaceType = this.referenceInterfaceBuilder.build();
				interfaceBuilder.withInterface(referenceInterfaceType);
				for (final GraphQLFieldDefinition field : referenceInterfaceType.getFieldDefinitions()) {
