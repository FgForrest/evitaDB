 ...
 */
public class OnCollectionSchemaChangeCaptureSubscribingDataFetcher
	...
	public OnCollectionSchemaChangeCaptureSubscribingDataFetcher(@Nonnull Evita evita, @Nonnull EntitySchemaContract entitySchema) {
		super(evita);
