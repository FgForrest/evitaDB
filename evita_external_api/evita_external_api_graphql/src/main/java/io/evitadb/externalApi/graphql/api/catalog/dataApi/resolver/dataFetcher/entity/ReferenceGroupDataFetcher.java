...
public class ReferenceGroupDataFetcher implements DataFetcher<EntityClassifier> {

	@Nullable
	private static ReferenceGroupDataFetcher INSTANCE;

	@Nonnull
	public static ReferenceGroupDataFetcher getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new ReferenceGroupDataFetcher();
		}
		return INSTANCE;
	}
