...
/**
 * The ScopedAttributeUniquenessTypeDto class encapsulates the relationship between an attribute's
 ...
 */
public record ScopedAttributeUniquenessTypeDto(
	@Nonnull Scope scope,
	@Nonnull AttributeUniquenessType uniquenessType
) {

	public ScopedAttributeUniquenessTypeDto {
