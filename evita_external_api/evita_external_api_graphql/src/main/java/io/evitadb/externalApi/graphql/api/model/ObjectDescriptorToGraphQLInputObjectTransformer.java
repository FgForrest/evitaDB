...
/**
 * Transforms API-independent {@link ObjectDescriptor} to GraphQL input object definition.
 *
...
public class ObjectDescriptorToGraphQLInputObjectTransformer implements ObjectDescriptorTransformer<GraphQLInputObjectType.Builder> {
	...
	@Override
	public GraphQLInputObjectType.Builder apply(ObjectDescriptor objectDescriptor) {
