 ...
 */
public class CatalogSchemaDataFetcher implements DataFetcher<CatalogSchemaContract> {

	@Nonnull
	@Override
	public CatalogSchemaContract get(@Nonnull DataFetchingEnvironment environment) {
