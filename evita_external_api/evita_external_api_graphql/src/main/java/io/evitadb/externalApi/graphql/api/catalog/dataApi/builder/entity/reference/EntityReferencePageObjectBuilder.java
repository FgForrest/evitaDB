...
public class EntityReferencePageObjectBuilder {
	...
	public GraphQLObjectType build(
		...
		// todo lho should this be somehow interfaced aswell? generic ReferencePage interface and named
		return NamedReferencePageDescriptor.THIS
			.to(this.objectBuilderTransformer)
			.name(NamedReferencePageDescriptor.THIS.name(collectionBuildingContext.getSchema(), referenceSchema))
