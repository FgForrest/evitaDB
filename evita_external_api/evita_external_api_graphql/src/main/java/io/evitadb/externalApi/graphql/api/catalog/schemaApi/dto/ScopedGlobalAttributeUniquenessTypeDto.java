...
/**
 * The ScopedGlobalAttributeUniquenessType class encapsulates the relationship between an attribute's
 ...
 */
public record ScopedGlobalAttributeUniquenessTypeDto(
	@Nonnull Scope scope,
	@Nonnull GlobalAttributeUniquenessType uniquenessType
) {

	public ScopedGlobalAttributeUniquenessTypeDto {
