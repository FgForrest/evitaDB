...
/**
 * Builds objects from {@link EntityReferenceStripDescriptor}
...
public class EntityReferenceStripObjectBuilder {
	...
	public GraphQLObjectType build(
		...
		final String objectName = ReferenceDefinitionStripDescriptor.THIS_INTERFACE.name(
			collectionBuildingContext.getSchema(),
			referenceSchema
		);

		final GraphQLObjectType.Builder objectBuilder = ReferenceDefinitionStripDescriptor.THIS_INTERFACE
		...
		objectBuilder.withInterface(typeRef(StripListDescriptor.THIS_INTERFACE.name()));
		...
		final GraphQLInterfaceType[] interfaces = new GraphQLInterfaceType[] {
			...
			this.referenceDefinitionStripInterfaceBuilder.getOrBuild(collectionBuildingContext, referenceSchema)
		};
