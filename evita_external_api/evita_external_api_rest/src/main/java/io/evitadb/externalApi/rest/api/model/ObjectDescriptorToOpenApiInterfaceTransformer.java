...
import io.evitadb.externalApi.rest.api.openApi.OpenApiInterface;
...
/**
 * Transforms API-independent {@link ObjectDescriptor} to {@link OpenApiInterface}.
 *
 * @author Martin Veska (veska@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class ObjectDescriptorToOpenApiInterfaceTransformer implements ObjectDescriptorTransformer<OpenApiInterface.Builder> {

	@Nonnull
	private final PropertyDescriptorTransformer<OpenApiProperty.Builder> propertyDescriptorTransformer;

	@Override
	public OpenApiInterface.Builder apply(ObjectDescriptor objectDescriptor) {
		final OpenApiInterface.Builder interfaceBuilder = OpenApiInterface.newInterface();
		...
		objectDescriptor.staticProperties()
			...
			.forEach(interfaceBuilder::property);
