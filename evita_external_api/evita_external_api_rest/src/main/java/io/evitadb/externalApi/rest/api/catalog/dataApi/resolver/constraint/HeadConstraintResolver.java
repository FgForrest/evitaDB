...
/**
 * Implementation of {@link ConstraintResolver} for resolving {@link io.evitadb.api.query.HeadConstraint} usually with {@link io.evitadb.api.query.head.Head}
 * as root container.
 *
 * @author Lukáš Hornych (hornych@fg.cz), FG Forrest a.s. (c) 2025
 */
public class HeadConstraintResolver extends RestConstraintResolver<HeadConstraint> {
