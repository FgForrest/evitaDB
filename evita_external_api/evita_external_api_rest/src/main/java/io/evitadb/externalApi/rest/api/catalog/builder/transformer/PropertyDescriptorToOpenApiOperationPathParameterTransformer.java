...
public class PropertyDescriptorToOpenApiOperationPathParameterTransformer implements PropertyDescriptorTransformer<OpenApiOperationParameter.Builder> {
	...
	public OpenApiOperationParameter.Builder apply(@Nonnull PropertyDescriptor propertyDescriptor) {
		final OpenApiOperationParameter.Builder parameterBuilder = OpenApiOperationParameter.newPathParameter()
