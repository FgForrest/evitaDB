...
/**
 * Implementation of {@link EntityUpsertMutationFactory} for input object structure specific to REST.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 * @author Martin Veska, FG Forrest a.s. (c) 2022
 */
public class RestEntityUpsertMutationFactory extends EntityUpsertMutationFactory<JsonNode> {

	public RestEntityUpsertMutationFactory(@Nonnull ObjectMapper objectMapper, @Nonnull EntitySchemaContract entitySchema) {
		super(entitySchema, objectMapper, new RestMutationObjectMapper(objectMapper), RestMutationResolvingExceptionFactory.INSTANCE);
	}
