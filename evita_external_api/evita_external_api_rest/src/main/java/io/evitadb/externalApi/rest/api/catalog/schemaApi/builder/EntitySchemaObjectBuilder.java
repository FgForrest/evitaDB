...
public class EntitySchemaObjectBuilder {
	...
	public void buildCommonTypes() {
		...
		this.buildingContext.registerType(ScopedAttributeUniquenessTypeDescriptor.THIS_INPUT.to(this.objectBuilderTransformer).build());
		...
		this.buildingContext.registerType(ScopedGlobalAttributeUniquenessTypeDescriptor.THIS_INPUT.to(this.objectBuilderTransformer).build());
