...
public record ProductRecord(
	...
	@ReferenceRef(Entities.CATEGORY) Collection<AbstractProductCategoryPojo> productCategories,
	@ReferenceRef(Entities.CATEGORY) List<AbstractProductCategoryPojo> productCategoriesAsList,
	@ReferenceRef(Entities.CATEGORY) Set<AbstractProductCategoryPojo> productCategoriesAsSet,
	@ReferenceRef(Entities.CATEGORY) AbstractProductCategoryPojo[] productCategoriesAsArray,
	@ReferenceRef(Entities.CATEGORY) Collection<AbstractCategoryPojo> categories,
	@ReferenceRef(Entities.CATEGORY) List<AbstractCategoryPojo> categoriesAsList,
	@ReferenceRef(Entities.CATEGORY) Set<AbstractCategoryPojo> categoriesAsSet,
	@ReferenceRef(Entities.CATEGORY) AbstractCategoryPojo[] categoriesAsArray,
