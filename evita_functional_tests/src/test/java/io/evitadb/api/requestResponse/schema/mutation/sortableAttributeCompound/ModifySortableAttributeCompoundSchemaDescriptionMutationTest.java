...
/**
 * This test verifies {@link ModifySortableAttributeCompoundSchemaDescriptionMutation} class.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
public class ModifySortableAttributeCompoundSchemaDescriptionMutationTest {

	@Test
	void shouldOverrideDescriptionOfPreviousMutationIfNamesMatch() {
		ModifySortableAttributeCompoundSchemaDescriptionMutation mutation = new ModifySortableAttributeCompoundSchemaDescriptionMutation(
			ATTRIBUTE_COMPOUND_NAME, "newDescription"
		);
		ModifySortableAttributeCompoundSchemaDescriptionMutation existingMutation = new ModifySortableAttributeCompoundSchemaDescriptionMutation(ATTRIBUTE_COMPOUND_NAME, "oldDescription");
	...
	void shouldLeaveBothMutationsIfTheNameOfNewMutationDoesntMatch() {
		...
		ModifySortableAttributeCompoundSchemaDescriptionMutation existingMutation = new ModifySortableAttributeCompoundSchemaDescriptionMutation("differentName", "oldDescription");
