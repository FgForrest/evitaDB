 ...
 */
public class ModifyEntitySchemaNameMutationTest {

	@Test
	void shouldMutateCatalogSchema() {
		ModifyEntitySchemaNameMutation mutation = new ModifyEntitySchemaNameMutation(
			"entityName",
			"newEntityName",
			true
		);
		...
		final EntitySchemaContract updatedSchema = entitySchemaAccessor.getEntitySchema("newEntityName").orElseThrow();
