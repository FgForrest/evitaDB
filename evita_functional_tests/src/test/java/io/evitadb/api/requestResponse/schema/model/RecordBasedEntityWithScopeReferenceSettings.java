...
/**
 * Example record for ClassSchemaAnalyzerTest demonstrating ScopeReferenceSettings usage with record components.
 * This entity shows how to configure different reference settings for different scopes using record component annotations.
 *
