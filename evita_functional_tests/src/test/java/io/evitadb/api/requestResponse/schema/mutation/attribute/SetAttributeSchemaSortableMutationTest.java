...
class SetAttributeSchemaSortableMutationTest {
	...
	void shouldOverrideSortableOfPreviousGlobalAttributeMutationIfNamesMatch() {
		...
		SetAttributeSchemaSortableMutation existingMutation = new SetAttributeSchemaSortableMutation(ATTRIBUTE_NAME, false);
	...
	void shouldLeaveBothMutationsIfTheNameOfNewGlobalAttributeMutationDoesntMatch() {
		...
		SetAttributeSchemaSortableMutation existingMutation = new SetAttributeSchemaSortableMutation("differentName", false);
