...
/**
 * Example interface for ClassSchemaAnalyzerTest demonstrating ScopeAttributeSettings usage.
 * This entity shows how to configure different attribute settings for different scopes.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2025
 */
@Entity
public interface GetterBasedEntityWithScopeAttributeSettings {
	...
	/**
	 * Attribute with no scope settings - should use defaults.
	 */
