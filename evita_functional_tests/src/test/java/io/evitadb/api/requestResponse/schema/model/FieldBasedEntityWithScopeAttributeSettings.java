...
/**
 * Example class for ClassSchemaAnalyzerTest demonstrating ScopeAttributeSettings usage with fields.
 * This entity shows how to configure different attribute settings for different scopes using field annotations.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2025
 */
@Entity
public class FieldBasedEntityWithScopeAttributeSettings {
