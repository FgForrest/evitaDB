 ...
 */
@Entity
public record RecordBasedEntityWithReflectedReferencedEntity(
	@PrimaryKey
	int id,
	...
	BrandReference marketingBrand
) {

	public record BrandReference(
		@ReferencedEntity
		Brand brand,
		@Attribute
		String brandNote,
	...
	public record ItemReference(
		@ReferencedEntity
		RecordBasedEntityWithReflectedReferencedEntity item,
