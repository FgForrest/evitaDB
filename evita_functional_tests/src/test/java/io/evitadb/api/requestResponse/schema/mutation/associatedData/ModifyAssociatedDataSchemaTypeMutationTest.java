...
class ModifyAssociatedDataSchemaTypeMutationTest {
	...
	void shouldOverrideTypeOfPreviousMutationIfNamesMatch() {
		ModifyAssociatedDataSchemaTypeMutation mutation = new ModifyAssociatedDataSchemaTypeMutation(
			ASSOCIATED_DATA_NAME, Integer.class
		);
		ModifyAssociatedDataSchemaTypeMutation existingMutation = new ModifyAssociatedDataSchemaTypeMutation(ASSOCIATED_DATA_NAME, String.class);
		...
		assertEquals(Integer.class, ((ModifyAssociatedDataSchemaTypeMutation) result.current()[0]).getType());
	}
	...
	void shouldLeaveBothMutationsIfTheNameOfNewMutationDoesntMatch() {
		...
		ModifyAssociatedDataSchemaTypeMutation existingMutation = new ModifyAssociatedDataSchemaTypeMutation("differentName", String.class);
	...
	void shouldMutateEntitySchema() {
		...
		assertEquals(String.class, newAssociatedDataSchema.getType());
	}
