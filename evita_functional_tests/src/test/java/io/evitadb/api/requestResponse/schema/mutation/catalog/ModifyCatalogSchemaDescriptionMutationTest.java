 ...
 */
public class ModifyCatalogSchemaDescriptionMutationTest {

	@Test
	void shouldMutateCatalogSchema() {
		ModifyCatalogSchemaDescriptionMutation mutation = new ModifyCatalogSchemaDescriptionMutation("newDescription");
