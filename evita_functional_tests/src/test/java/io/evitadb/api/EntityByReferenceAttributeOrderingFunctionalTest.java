...
import io.evitadb.api.EntityByAttributeFilteringFunctionalTest.PredicateWithComparatorTuple;
...
import static io.evitadb.api.EntityByAttributeFilteringFunctionalTest.assertSortedResultIs;
 ...
 */
@DisplayName("Evita entity filtering by reference attributes functionality")
@Tag(FUNCTIONAL_TEST)
@ExtendWith(EvitaParameterResolver.class)
@Slf4j
public class EntityByReferenceAttributeOrderingFunctionalTest {
