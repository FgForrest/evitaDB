...
class HierarchyFromNodeTest {
	...
	void shouldToStringReturnExpectedFormat() {
		...
		assertEquals("fromNode('megaMenu',node(filterBy(entityPrimaryKeyInSet(1))),entityFetch(attributeContent(),hierarchyContent(),associatedDataContent(),priceContent(ALL),referenceContent(),dataInLocales()))", hierarchyFromNode2.toString());
