...
/**
 * This tests verifies basic properties of {@link HierarchyHaving} query.
 *
...
class HierarchyHavingTest {
	...
	void shouldConformToEqualsAndHashContract() {
		...
		assertEquals(having(attributeEquals("code", "a")).hashCode(), having(attributeEquals("code", "a")).hashCode());
		assertNotEquals(having(attributeEquals("code", "a")).hashCode(), having(entityPrimaryKeyInSet(1)).hashCode());
	}
