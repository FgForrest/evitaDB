...
class EvitaQLOrderConstraintListVisitorTest {
    ...
    void shouldNotParseOrderConstraintList() {
        assertThrows(EvitaQLInvalidQueryError.class, () -> parseOrderConstraintList("collection('code')"));
        assertThrows(EvitaQLInvalidQueryError.class, () -> parseOrderConstraintList("attributeNatural('product'),collection('code')"));
    }
