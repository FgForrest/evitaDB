...
public class ExpressionTest {
	...
	static Stream<Arguments> predicates() {
		return Stream.of(
			...
			Arguments.of("10 <= 5 || 5 >= 10", Map.of(), false, BigDecimalNumberRange.INFINITE),
			Arguments.of("10 <= 5 || 6 >= 5", Map.of(), true, BigDecimalNumberRange.INFINITE),
			...
			Arguments.of("max(4, 8) > 5", Map.of(), true, BigDecimalNumberRange.from(new BigDecimal("4.0000000000000001"))),
			Arguments.of("max(4, 8) < 5", Map.of(), false, BigDecimalNumberRange.to(new BigDecimal("4.9999999999999999"))),
			Arguments.of("min(4, 8) > 5", Map.of(), false, BigDecimalNumberRange.from(new BigDecimal("4.0000000000000001"))),
			Arguments.of("min(4, 8) < 5", Map.of(), true, BigDecimalNumberRange.to(new BigDecimal("4.9999999999999999"))),
			Arguments.of("abs(-4) == 4", Map.of(), true, BigDecimalNumberRange.between(new BigDecimal("4"), new BigDecimal("4"))),
			Arguments.of("round(log(20)) == 3", Map.of(), true, BigDecimalNumberRange.between(new BigDecimal("3"), new BigDecimal("3"))),
			Arguments.of("round(2.4) == 2", Map.of(), true, BigDecimalNumberRange.between(new BigDecimal("2"), new BigDecimal("2"))),
			Arguments.of("round(2.5) == 3", Map.of(), true, BigDecimalNumberRange.between(new BigDecimal("3"), new BigDecimal("3"))),
			...
			Arguments.of("$pageNumber <= 5 || $pageNumber >= 2", Map.of("pageNumber", BigDecimal.valueOf(10)), true, BigDecimalNumberRange.INFINITE),
