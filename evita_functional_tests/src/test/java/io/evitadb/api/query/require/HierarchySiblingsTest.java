...
class HierarchySiblingsTest {
	...
	void shouldToStringReturnExpectedFormat() {
		...
		assertEquals("siblings('megaMenu',entityFetch(attributeContentAll(),hierarchyContent(),associatedDataContentAll(),priceContentAll(),referenceContentAll(),dataInLocales()))", hierarchySiblings1.toString());
