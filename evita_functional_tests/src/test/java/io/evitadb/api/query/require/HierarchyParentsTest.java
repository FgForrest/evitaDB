...
class HierarchyParentsTest {
	...
	void shouldToStringReturnExpectedFormat() {
		...
		assertEquals("parents('megaMenu',entityFetch(attributeContentAll(),hierarchyContent(),associatedDataContentAll(),priceContentAll(),referenceContentAll(),dataInLocales()))", hierarchyParents2.toString());
