...
class HierarchyParentsTest {
	...
	void shouldToStringReturnExpectedFormat() {
		...
		assertEquals("parents('megaMenu',entityFetch(attributeContent(),hierarchyContent(),associatedDataContent(),priceContent(ALL),referenceContent(),dataInLocales()))", hierarchyParents2.toString());
