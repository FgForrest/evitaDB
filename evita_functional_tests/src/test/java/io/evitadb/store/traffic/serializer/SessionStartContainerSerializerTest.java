...
/**
 * This test verifies the correctness of the {@link SessionStartContainerSerializer} class.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2024
 */
class SessionStartContainerSerializerTest extends AbstractContainerSerializerTest {
