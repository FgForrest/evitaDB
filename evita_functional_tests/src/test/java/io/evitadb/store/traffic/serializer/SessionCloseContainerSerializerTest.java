...
/**
 * This test verifies the correctness of the {@link SessionCloseContainerSerializer} class.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2024
 */
class SessionCloseContainerSerializerTest extends AbstractContainerSerializerTest {
