...
/**
 * This test verifies the correctness of the {@link TransactionalIntBPlusTree} implementation.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2025
 */
class TransactionalIntBPlusTreeTest implements TimeBoundedTestSupport {

	private static void verifyTreeConsistency(@Nonnull TransactionalIntBPlusTree<String> bPlusTree, int... expectedArray) {
	...
	private static TreeTuple prepareRandomTree(
		...
		final TransactionalIntBPlusTree<String> bPlusTree = new TransactionalIntBPlusTree<>(valueBlockSize, minValueBlockSize, internalNodeSize, minInternalNodeSize, String.class);
	...
	void shouldOverwriteDuplicateKeys() {
		TransactionalIntBPlusTree<String> bPlusTree = new TransactionalIntBPlusTree<>(3, String.class);
	...
	void shouldMergeWithLeftNode() {
		...
		final AtomicReference<TransactionalIntBPlusTree<String>> theTree = new AtomicReference<>(testTree.bPlusTree());
