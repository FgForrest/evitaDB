...
public class DelegatingLocalMutationConverterTest {
	...
	private DelegatingLocalMutationConverter converter;

	@BeforeEach
	void init() {
		this.converter =  new DelegatingLocalMutationConverter(new ObjectMapper(), PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
