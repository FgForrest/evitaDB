...
class SetReferenceSchemaFilterableMutationConverterTest {
	...
	void shouldResolveInputToLocalMutation() {
		...
		final SetReferenceSchemaIndexedMutation convertedMutation1 = converter.convertFromInput(
			map()
		...
		final SetReferenceSchemaIndexedMutation convertedMutation2 = converter.convertFromInput(
			map()
				.e(ReferenceSchemaMutationDescriptor.NAME.name(), "tags")
				.e(SetReferenceSchemaIndexedMutationDescriptor.INDEXED.name(), "true")
				.build()
