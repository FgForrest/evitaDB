...
public class DelegatingInfrastructureMutationConverterTest {
	...
	private DelegatingInfrastructureMutationConverter converter;

	@BeforeEach
	void init() {
		this.converter = new DelegatingInfrastructureMutationConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
	...
	void shouldSerializeMutationToOutput() {
		...
		assertThat(serializedMutation)
			...
			.isEqualTo(
				list()
					.i(map()
					   .e(TransactionMutationDescriptor.MUTATION_TYPE.name(), TransactionMutation.class.getSimpleName())
