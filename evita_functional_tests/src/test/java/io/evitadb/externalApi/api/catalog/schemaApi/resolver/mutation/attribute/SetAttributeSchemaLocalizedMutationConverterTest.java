...
class SetAttributeSchemaLocalizedMutationConverterTest {
	...
	void shouldResolveInputToLocalMutation() {
		...
		final SetAttributeSchemaLocalizedMutation convertedMutation1 = converter.convertFromInput(
			map()
		...
		final SetAttributeSchemaLocalizedMutation convertedMutation2 = converter.convertFromInput(
			map()
				.e(AttributeSchemaMutationDescriptor.NAME.name(), "code")
				.e(SetAttributeSchemaLocalizedMutationDescriptor.LOCALIZED.name(), "true")
				.build()
