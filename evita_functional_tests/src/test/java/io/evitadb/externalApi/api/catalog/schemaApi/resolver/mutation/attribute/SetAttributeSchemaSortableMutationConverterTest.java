...
class SetAttributeSchemaSortableMutationConverterTest {
	...
	@BeforeEach
	void init() {
		this.converter = new SetAttributeSchemaSortableMutationConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
	...
	void shouldSerializeLocalMutationToOutput() {
		final SetAttributeSchemaSortableMutation inputMutation = new SetAttributeSchemaSortableMutation(
			"code",
			new Scope[] { Scope.LIVE }
		);
		...
		assertThat(serializedMutation)
			...
			.isEqualTo(
				map()
					.e(MutationDescriptor.MUTATION_TYPE.name(), SetAttributeSchemaSortableMutation.class.getSimpleName())
					.e(AttributeSchemaMutationDescriptor.NAME.name(), "code")
					.e(SetAttributeSchemaSortableMutationDescriptor.SORTABLE_IN_SCOPES.name(), new String[] { Scope.LIVE.name() })
					.build()
			);
	}
}
