...
class ModifySortableAttributeCompoundSchemaDescriptionMutationConverterTest {
	...
	void shouldResolveInputToLocalMutation() {
		...
		final ModifySortableAttributeCompoundSchemaDescriptionMutation convertedMutation = this.converter.convertFromInput(
			map()
	...
	void shouldSerializeLocalMutationToOutput() {
		final ModifySortableAttributeCompoundSchemaDescriptionMutation inputMutation = new ModifySortableAttributeCompoundSchemaDescriptionMutation(
			"code",
			"desc"
		);
