...
/**
 * Tests for {@link AttributeMutationInputAggregateConverter}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2022
 */
class DelegateAttributeMutationConverterTest {

	private static final String ATTRIBUTE_QUANTITY = "quantity";

	private DelegatingAttributeMutationConverter converter;

	@BeforeEach
	void init() {
		this.converter =  new DelegatingAttributeMutationConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
				...
				list()
					.i(map()
						...
						.e(ApplyDeltaAttributeMutationDescriptor.REQUIRED_RANGE_AFTER_APPLICATION.name(), array()
							.i(0).i(20)))
					.i(map()
						.e(RemoveAttributeMutationDescriptor.MUTATION_TYPE.name(), RemoveAttributeMutation.class.getSimpleName())
