...
class LocalCatalogSchemaMutationInputAggregateConverterTest {
	...
	@BeforeEach
	void init() {
		this.converter = new LocalCatalogSchemaMutationInputAggregateConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
	...
	void shouldResolveInputToLocalMutation() {
		...
		final List<LocalCatalogSchemaMutation> convertedMutations1 = this.converter.convertFromInput(
			map()
				.e(
					LocalCatalogSchemaMutationInputAggregateDescriptor.MODIFY_ATTRIBUTE_SCHEMA_DESCRIPTION_MUTATION.name(), map()
				...
				.e(
					...
					.build())
				.e(
					LocalCatalogSchemaMutationInputAggregateDescriptor.DISALLOW_EVOLUTION_MODE_IN_CATALOG_SCHEMA_MUTATION.name(), map()
