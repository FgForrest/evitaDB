...
class ModifyEntitySchemaDescriptionMutationConverterTest {
	...
	@BeforeEach
	void init() {
		this.converter = new ModifyEntitySchemaDescriptionMutationConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
	...
	void shouldSerializeLocalMutationToOutput() {
		...
		assertThat(serializedMutation)
			...
			.isEqualTo(
				map()
					.e(MutationDescriptor.MUTATION_TYPE.name(), ModifyEntitySchemaDescriptionMutation.class.getSimpleName())
					.e(ModifyEntitySchemaDescriptionMutationDescriptor.DESCRIPTION.name(), "desc")
					.build()
			);
	}
