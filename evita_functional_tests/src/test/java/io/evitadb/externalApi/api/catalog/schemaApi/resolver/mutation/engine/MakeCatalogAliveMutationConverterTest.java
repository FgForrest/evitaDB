 ...
 */
public class MakeCatalogAliveMutationConverterTest {

	private MakeCatalogAliveMutationConverter converter;

	@BeforeEach
	void init() {
		this.converter = new MakeCatalogAliveMutationConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}

	@Test
	void shouldResolverInputToLocalMutation() {
		final MakeCatalogAliveMutation expectedMutation = new MakeCatalogAliveMutation("testCatalog");
		final MakeCatalogAliveMutation convertedMutation = this.converter.convertFromInput(
			map()
	...
	void shouldSerializeLocalMutationToOutput() {
		final MakeCatalogAliveMutation inputMutation = new MakeCatalogAliveMutation("testCatalog");
		...
		assertThat(serializedMutation)
			...
			.isEqualTo(
				map()
					.e(MutationDescriptor.MUTATION_TYPE.name(), MakeCatalogAliveMutation.class.getSimpleName())
					.e(EngineMutationDescriptor.CATALOG_NAME.name(), "testCatalog")
					.build()
			);
	}
