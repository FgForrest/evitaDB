...
/**
 * Tests for {@link DelegatingSortableAttributeCompoundSchemaMutationConverter}
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
class DelegatingSortableAttributeCompoundSchemaMutationConverterTest {

	private DelegatingSortableAttributeCompoundSchemaMutationConverter converter;

	@BeforeEach
	void init() {
		this.converter = new DelegatingSortableAttributeCompoundSchemaMutationConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
	...
	void shouldConvertMutationToOutput() {
		final List<Map<String, Object>> expectedMutations = List.of(
			map()
				.e(ModifySortableAttributeCompoundSchemaDescriptionMutationDescriptor.MUTATION_TYPE.name(),
				   ModifySortableAttributeCompoundSchemaDescriptionMutation.class.getSimpleName()
				)
				.e(ModifySortableAttributeCompoundSchemaDescriptionMutationDescriptor.NAME.name(), "code")
				.e(ModifySortableAttributeCompoundSchemaDescriptionMutationDescriptor.DESCRIPTION.name(), "desc")
				.build(),
			map()
				.e(ModifySortableAttributeCompoundSchemaNameMutationDescriptor.MUTATION_TYPE.name(), ModifySortableAttributeCompoundSchemaNameMutation.class.getSimpleName())
				.e(ModifySortableAttributeCompoundSchemaNameMutationDescriptor.NAME.name(), "code")
				.e(ModifySortableAttributeCompoundSchemaNameMutationDescriptor.NEW_NAME.name(), "betterCode")
				.build()
		);
