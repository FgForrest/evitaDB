...
class ModifySortableAttributeCompoundSchemaNameMutationConverterTest {
	...
	@BeforeEach
	void init() {
		this.converter = new ModifySortableAttributeCompoundSchemaNameMutationConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
	...
	void shouldSerializeLocalMutationToOutput() {
		final ModifySortableAttributeCompoundSchemaNameMutation inputMutation = new ModifySortableAttributeCompoundSchemaNameMutation(
			"code",
			"label"
		);
		...
		assertThat(serializedMutation)
			...
			.isEqualTo(
				map()
					.e(MutationDescriptor.MUTATION_TYPE.name(), ModifySortableAttributeCompoundSchemaNameMutation.class.getSimpleName())
					.e(SortableAttributeCompoundSchemaMutationDescriptor.NAME.name(), "code")
					.e(ModifySortableAttributeCompoundSchemaNameMutationDescriptor.NEW_NAME.name(), "label")
					.build()
			);
