 ...
 */
class AttributeMutationInputAggregateConverterTest {
	...
	private AttributeMutationInputAggregateConverter converter;
	...
	void init() {
		...
		this.converter =  new AttributeMutationInputAggregateConverter(PassThroughMutationObjectMapper.INSTANCE, TestMutationResolvingExceptionFactory.INSTANCE);
	}
