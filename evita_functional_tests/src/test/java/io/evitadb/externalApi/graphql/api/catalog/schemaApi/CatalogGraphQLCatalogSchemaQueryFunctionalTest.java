				...
				equalTo(
					map()
						...
						.e(CatalogSchemaDescriptor.NAME_VARIANTS.name(), map()
							...
							.e(SchemaNameVariantsDescriptor.CAMEL_CASE.name(), catalogSchema.getNameVariants().get(NamingConvention.CAMEL_CASE))
							.e(SchemaNameVariantsDescriptor.PASCAL_CASE.name(), catalogSchema.getNameVariants().get(NamingConvention.PASCAL_CASE))
							.e(SchemaNameVariantsDescriptor.SNAKE_CASE.name(), catalogSchema.getNameVariants().get(NamingConvention.SNAKE_CASE))
							.e(SchemaNameVariantsDescriptor.UPPER_SNAKE_CASE.name(), catalogSchema.getNameVariants().get(NamingConvention.UPPER_SNAKE_CASE))
							.e(SchemaNameVariantsDescriptor.KEBAB_CASE.name(), catalogSchema.getNameVariants().get(NamingConvention.KEBAB_CASE))
							.build())
						...
						.e(EntitySchemaDescriptor.ATTRIBUTES.name(), map()
							...
							.e(ATTRIBUTE_URL, map()
								...
								.e(GlobalAttributeSchemaDescriptor.NAME_VARIANTS.name(), map()
									.e(TYPENAME_FIELD, SchemaNameVariantsDescriptor.THIS.name())
									.e(SchemaNameVariantsDescriptor.CAMEL_CASE.name(), urlSchema.getNameVariant(NamingConvention.CAMEL_CASE))
									.e(SchemaNameVariantsDescriptor.PASCAL_CASE.name(), urlSchema.getNameVariant(NamingConvention.PASCAL_CASE))
									.e(SchemaNameVariantsDescriptor.SNAKE_CASE.name(), urlSchema.getNameVariant(NamingConvention.SNAKE_CASE))
									.e(SchemaNameVariantsDescriptor.UPPER_SNAKE_CASE.name(), urlSchema.getNameVariant(NamingConvention.UPPER_SNAKE_CASE))
									.e(SchemaNameVariantsDescriptor.KEBAB_CASE.name(), urlSchema.getNameVariant(NamingConvention.KEBAB_CASE))
									.build())
