 ...
 */
class DelegatingEntityMutationConverterTest {

	private static DelegatingEntityMutationConverter converter;
	...
	void shouldConvertMutation() {
		final EntityRemoveMutation mutation = new EntityRemoveMutation("product", 1);
		assertEquals(
			mutation,
