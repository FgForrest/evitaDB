...
class ModifySortableAttributeCompoundSchemaNameMutationConverterTest {
	...
	private static ModifySortableAttributeCompoundSchemaNameMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifySortableAttributeCompoundSchemaNameMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifySortableAttributeCompoundSchemaNameMutation mutation1 = new ModifySortableAttributeCompoundSchemaNameMutation(
			"code", "code2"
		);
