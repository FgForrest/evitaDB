...
class SetAttributeSchemaNullableMutationConverterTest {
	...
	private static SetAttributeSchemaNullableMutationConverter converter;
	...
	void shouldConvertMutation() {
		final SetAttributeSchemaNullableMutation mutation1 = new SetAttributeSchemaNullableMutation(
			"code", true
		);
