...
class DisallowEvolutionModeInEntitySchemaMutationConverterTest {
	...
	private static DisallowEvolutionModeInEntitySchemaMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = DisallowEvolutionModeInEntitySchemaMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final DisallowEvolutionModeInEntitySchemaMutation mutation1 = new DisallowEvolutionModeInEntitySchemaMutation(
