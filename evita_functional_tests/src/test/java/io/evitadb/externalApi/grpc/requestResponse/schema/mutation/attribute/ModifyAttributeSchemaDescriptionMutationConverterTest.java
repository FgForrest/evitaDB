...
class ModifyAttributeSchemaDescriptionMutationConverterTest {
	...
	private static ModifyAttributeSchemaDescriptionMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyAttributeSchemaDescriptionMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyAttributeSchemaDescriptionMutation mutation1 = new ModifyAttributeSchemaDescriptionMutation(
			"code", "desc"
		);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final ModifyAttributeSchemaDescriptionMutation mutation2 = new ModifyAttributeSchemaDescriptionMutation(
			"code", null
		);
