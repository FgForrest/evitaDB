...
class ModifyReferenceSortableAttributeCompoundSchemaMutationConverterTest {
	...
	private static ModifyReferenceSortableAttributeCompoundSchemaMutationConverter converter;
	...
	void shouldConvertMutation() {
		final ModifyReferenceSortableAttributeCompoundSchemaMutation mutation1 = new ModifyReferenceSortableAttributeCompoundSchemaMutation(
			"tags",
			new RemoveSortableAttributeCompoundSchemaMutation("codeName")
		);
