...
class ModifyReferenceSchemaNameMutationConverterTest {
	...
	private static ModifyReferenceSchemaNameMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyReferenceSchemaNameMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyReferenceSchemaNameMutation mutation1 = new ModifyReferenceSchemaNameMutation(
			"tags",
			"newTags"
		);
