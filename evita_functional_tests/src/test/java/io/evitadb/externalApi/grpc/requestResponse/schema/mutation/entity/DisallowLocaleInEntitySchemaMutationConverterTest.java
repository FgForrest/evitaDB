...
class DisallowLocaleInEntitySchemaMutationConverterTest {
	...
	private static DisallowLocaleInEntitySchemaMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = DisallowLocaleInEntitySchemaMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final DisallowLocaleInEntitySchemaMutation mutation1 = new DisallowLocaleInEntitySchemaMutation(Locale.US);
