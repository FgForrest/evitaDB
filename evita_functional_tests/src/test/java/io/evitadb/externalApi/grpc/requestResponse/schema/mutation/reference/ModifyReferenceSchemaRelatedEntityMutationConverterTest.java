...
class ModifyReferenceSchemaRelatedEntityMutationConverterTest {
	...
	private static ModifyReferenceSchemaRelatedEntityMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyReferenceSchemaRelatedEntityMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyReferenceSchemaRelatedEntityMutation mutation1 = new ModifyReferenceSchemaRelatedEntityMutation(
			"tags",
			"tag",
			false
		);
