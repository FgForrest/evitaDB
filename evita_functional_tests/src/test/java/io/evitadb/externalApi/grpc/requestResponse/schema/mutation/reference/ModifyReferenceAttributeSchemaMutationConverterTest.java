...
class ModifyReferenceAttributeSchemaMutationConverterTest {
	...
	private static ModifyReferenceAttributeSchemaMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyReferenceAttributeSchemaMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyReferenceAttributeSchemaMutation mutation1 = new ModifyReferenceAttributeSchemaMutation(
			"tags",
			new RemoveAttributeSchemaMutation("code")
		);
