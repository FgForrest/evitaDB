...
class ModifyEntitySchemaMutationConverterTest {
	...
	private static ModifyEntitySchemaMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyEntitySchemaMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyEntitySchemaMutation mutation1 = new ModifyEntitySchemaMutation(
			"testCatalog", new ModifyEntitySchemaDescriptionMutation("desc")
		);
