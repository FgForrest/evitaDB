...
class ModifyAttributeSchemaTypeMutationConverterTest {
	...
	private static ModifyAttributeSchemaTypeMutationConverter converter;
	...
	void shouldConvertMutation() {
		final ModifyAttributeSchemaTypeMutation mutation1 = new ModifyAttributeSchemaTypeMutation(
			"code", String.class, 0
		);
