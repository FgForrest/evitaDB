...
class RemoveAssociatedDataMutationConverterTest {
	...
	private static RemoveAssociatedDataMutationConverter converter;
	...
	void shouldConvertMutation() {
		final RemoveAssociatedDataMutation mutation1 = new RemoveAssociatedDataMutation("labels", Locale.US);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final RemoveAssociatedDataMutation mutation2 = new RemoveAssociatedDataMutation("labels");
