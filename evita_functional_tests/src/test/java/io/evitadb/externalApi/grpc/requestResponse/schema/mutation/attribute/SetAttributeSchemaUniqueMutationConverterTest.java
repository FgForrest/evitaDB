...
class SetAttributeSchemaUniqueMutationConverterTest {
	...
	private static SetAttributeSchemaUniqueMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = SetAttributeSchemaUniqueMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final SetAttributeSchemaUniqueMutation mutation1 = new SetAttributeSchemaUniqueMutation(
			"code", AttributeUniquenessType.UNIQUE_WITHIN_COLLECTION
		);
