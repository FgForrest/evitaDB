...
class CreateAssociatedDataSchemaMutationConverterTest {
	...
	private static CreateAssociatedDataSchemaMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = CreateAssociatedDataSchemaMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final CreateAssociatedDataSchemaMutation mutation1 = new CreateAssociatedDataSchemaMutation(
			"labels", "desc", "depr", String.class, true, false
		);
		...
		final CreateAssociatedDataSchemaMutation mutation2 = new CreateAssociatedDataSchemaMutation(
			"labels", null, null, String.class, true, false
		);
