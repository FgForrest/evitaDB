...
class SetEntitySchemaWithGeneratedPrimaryKeyMutationConverterTest {
	...
	private static SetEntitySchemaWithGeneratedPrimaryKeyMutationConverter converter;
	...
	void shouldConvertMutation() {
		final SetEntitySchemaWithGeneratedPrimaryKeyMutation mutation1 = new SetEntitySchemaWithGeneratedPrimaryKeyMutation(
			true
		);
