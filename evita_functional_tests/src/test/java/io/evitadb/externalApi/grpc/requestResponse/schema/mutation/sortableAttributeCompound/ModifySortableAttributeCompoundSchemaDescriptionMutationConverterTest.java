...
class ModifySortableAttributeCompoundSchemaDescriptionMutationConverterTest {
	...
	private static ModifySortableAttributeCompoundSchemaDescriptionMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifySortableAttributeCompoundSchemaDescriptionMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifySortableAttributeCompoundSchemaDescriptionMutation mutation1 = new ModifySortableAttributeCompoundSchemaDescriptionMutation(
			"code", "desc"
		);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final ModifySortableAttributeCompoundSchemaDescriptionMutation mutation2 = new ModifySortableAttributeCompoundSchemaDescriptionMutation(
			"code", null
		);
