...
class RemoveReferenceMutationConverterTest {
	...
	private static RemoveReferenceMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = RemoveReferenceMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final RemoveReferenceMutation mutation1 = new RemoveReferenceMutation(
