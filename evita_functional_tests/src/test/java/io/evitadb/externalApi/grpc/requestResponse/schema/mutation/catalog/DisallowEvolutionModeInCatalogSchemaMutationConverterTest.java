...
class DisallowEvolutionModeInCatalogSchemaMutationConverterTest {
	...
	private static DisallowEvolutionModeInCatalogSchemaMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = DisallowEvolutionModeInCatalogSchemaMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final DisallowEvolutionModeInCatalogSchemaMutation mutation1 = new DisallowEvolutionModeInCatalogSchemaMutation(
