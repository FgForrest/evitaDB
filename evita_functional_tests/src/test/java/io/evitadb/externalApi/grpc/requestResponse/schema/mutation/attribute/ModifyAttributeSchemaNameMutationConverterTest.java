...
class ModifyAttributeSchemaNameMutationConverterTest {
	...
	private static ModifyAttributeSchemaNameMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyAttributeSchemaNameMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyAttributeSchemaNameMutation mutation1 = new ModifyAttributeSchemaNameMutation(
			"code", "code2"
		);
