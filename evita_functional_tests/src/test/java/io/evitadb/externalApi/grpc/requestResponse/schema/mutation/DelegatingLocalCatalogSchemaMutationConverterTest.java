...
class DelegatingLocalCatalogSchemaMutationConverterTest {
	...
	private static DelegatingLocalCatalogSchemaMutationConverter converter;
	...
	void shouldConvertMutation() {
		final ModifyCatalogSchemaDescriptionMutation mutation = new ModifyCatalogSchemaDescriptionMutation("desc");
		assertEquals(
			mutation,
