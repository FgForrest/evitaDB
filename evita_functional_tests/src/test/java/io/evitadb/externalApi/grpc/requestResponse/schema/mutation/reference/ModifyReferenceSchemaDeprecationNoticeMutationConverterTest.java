...
class ModifyReferenceSchemaDeprecationNoticeMutationConverterTest {
	...
	private static ModifyReferenceSchemaDeprecationNoticeMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyReferenceSchemaDeprecationNoticeMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyReferenceSchemaDeprecationNoticeMutation mutation1 = new ModifyReferenceSchemaDeprecationNoticeMutation(
			"tags",
			"depr"
		);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final ModifyReferenceSchemaDeprecationNoticeMutation mutation2 = new ModifyReferenceSchemaDeprecationNoticeMutation(
			"tags",
			null
		);
