...
class SetAttributeSchemaLocalizedMutationConverterTest {
	...
	private static SetAttributeSchemaLocalizedMutationConverter converter;
	...
	void shouldConvertMutation() {
		final SetAttributeSchemaLocalizedMutation mutation1 = new SetAttributeSchemaLocalizedMutation(
			"code", true
		);
