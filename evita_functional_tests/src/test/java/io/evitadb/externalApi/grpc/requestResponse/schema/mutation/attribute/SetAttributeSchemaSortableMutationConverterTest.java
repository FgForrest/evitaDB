...
class SetAttributeSchemaSortableMutationConverterTest {
	...
	private static SetAttributeSchemaSortableMutationConverter converter;
	...
	void shouldConvertMutation() {
		final SetAttributeSchemaSortableMutation mutation1 = new SetAttributeSchemaSortableMutation(
			"code", true
		);
