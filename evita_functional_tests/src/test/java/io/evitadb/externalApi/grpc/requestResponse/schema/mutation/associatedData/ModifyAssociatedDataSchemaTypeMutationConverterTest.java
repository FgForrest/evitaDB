...
class ModifyAssociatedDataSchemaTypeMutationConverterTest {
	...
	private static ModifyAssociatedDataSchemaTypeMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyAssociatedDataSchemaTypeMutationConverter.INSTANCE;
	}
