...
class SetAttributeSchemaRepresentativeMutationConverterTest {
	...
	private static SetAttributeSchemaRepresentativeMutationConverter converter;
	...
	void shouldConvertMutation() {
		final SetAttributeSchemaRepresentativeMutation mutation1 = new SetAttributeSchemaRepresentativeMutation(
			"code", true
		);
