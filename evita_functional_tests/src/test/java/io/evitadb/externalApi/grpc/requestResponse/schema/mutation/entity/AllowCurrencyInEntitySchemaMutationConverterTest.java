...
class AllowCurrencyInEntitySchemaMutationConverterTest {
	...
	private static AllowCurrencyInEntitySchemaMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = AllowCurrencyInEntitySchemaMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final AllowCurrencyInEntitySchemaMutation mutation1 = new AllowCurrencyInEntitySchemaMutation(
