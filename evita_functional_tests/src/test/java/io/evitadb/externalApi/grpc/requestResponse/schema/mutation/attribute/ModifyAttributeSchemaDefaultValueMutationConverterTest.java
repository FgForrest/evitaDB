...
class ModifyAttributeSchemaDefaultValueMutationConverterTest {
	...
	private static ModifyAttributeSchemaDefaultValueMutationConverter converter;
	...
	void shouldConvertMutation() {
		final ModifyAttributeSchemaDefaultValueMutation mutation1 = new ModifyAttributeSchemaDefaultValueMutation(
			"code", "defaultCode"
		);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final ModifyAttributeSchemaDefaultValueMutation mutation2 = new ModifyAttributeSchemaDefaultValueMutation(
			"code", null
		);
