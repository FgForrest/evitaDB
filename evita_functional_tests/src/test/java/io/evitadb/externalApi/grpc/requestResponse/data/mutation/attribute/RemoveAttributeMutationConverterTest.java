...
class RemoveAttributeMutationConverterTest {
	...
	private static RemoveAttributeMutationConverter converter;
	...
	void shouldConvertMutation() {
		final RemoveAttributeMutation mutation1 = new RemoveAttributeMutation("code", Locale.US);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final RemoveAttributeMutation mutation2 = new RemoveAttributeMutation("code");
