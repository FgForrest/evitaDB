...
class ModifyAssociatedDataSchemaDeprecationNoticeMutationConverterTest {
	...
	private static ModifyAssociatedDataSchemaDeprecationNoticeMutationConverter converter;
	...
	void shouldConvertMutation() {
		final ModifyAssociatedDataSchemaDeprecationNoticeMutation mutation1 = new ModifyAssociatedDataSchemaDeprecationNoticeMutation(
			"labels", "depr"
		);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final ModifyAssociatedDataSchemaDeprecationNoticeMutation mutation2 = new ModifyAssociatedDataSchemaDeprecationNoticeMutation(
			"labels", null
		);
