...
class ModifyEntitySchemaDeprecationNoticeMutationConverterTest {
	...
	private static ModifyEntitySchemaDeprecationNoticeMutationConverter converter;

	@BeforeAll
	static void setup() {
		converter = ModifyEntitySchemaDeprecationNoticeMutationConverter.INSTANCE;
	}

	@Test
	void shouldConvertMutation() {
		final ModifyEntitySchemaDeprecationNoticeMutation mutation1 = new ModifyEntitySchemaDeprecationNoticeMutation(
			"depr"
		);
		assertEquals(mutation1, converter.convert(converter.convert(mutation1)));

		final ModifyEntitySchemaDeprecationNoticeMutation mutation2 = new ModifyEntitySchemaDeprecationNoticeMutation(
			null
		);
