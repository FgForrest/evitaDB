...
abstract class CatalogRestSchemaEndpointFunctionalTest extends RestEndpointFunctionalTest {
	...
	protected static Map<String, Object> createCatalogSchemaDto(@Nonnull Evita evita,
		...
		final MapBuilder catalogSchemaDto = map()
			...
			.e(NamedSchemaDescriptor.NAME_VARIANTS.name(), map()
				.e(SchemaNameVariantsDescriptor.CAMEL_CASE.name(), catalogSchema.getNameVariant(NamingConvention.CAMEL_CASE))
				.e(SchemaNameVariantsDescriptor.PASCAL_CASE.name(), catalogSchema.getNameVariant(NamingConvention.PASCAL_CASE))
				.e(SchemaNameVariantsDescriptor.SNAKE_CASE.name(), catalogSchema.getNameVariant(NamingConvention.SNAKE_CASE))
				.e(SchemaNameVariantsDescriptor.UPPER_SNAKE_CASE.name(), catalogSchema.getNameVariant(NamingConvention.UPPER_SNAKE_CASE))
				.e(SchemaNameVariantsDescriptor.KEBAB_CASE.name(), catalogSchema.getNameVariant(NamingConvention.KEBAB_CASE))
				.build())
	...
	@Nonnull
	protected static Map<String, Object> createEntitySchemaDto(@Nonnull Evita evita, @Nonnull EntitySchemaContract productSchema) {
		final MapBuilder entitySchemaDto = map()
			.e(VersionedDescriptor.VERSION.name(), productSchema.getVersion())
