...
/**
 * Exception wraps the exception thrown from the Java example code.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2023
 */
public class JavaExecutionException extends IllegalStateException {
	@Serial private static final long serialVersionUID = 8516782773837833098L;

	public JavaExecutionException(@Nonnull JShellException exception) {
		super(printException(exception, new HashSet<>()) + "\n");
	}
