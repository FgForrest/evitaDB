...
/**
 * Factory for {@link RestTestContext}.
 *
 * @author Lukáš Hornych, FG Forrest a.s. (c) 2023
 */
public class RestTestContextFactory implements TestContextFactory<RestTestContext> {
	/**
	 * Memorized reference to the {@link RestTestContext} that is shared for all Java dynamic tests in the same document.
	 */
