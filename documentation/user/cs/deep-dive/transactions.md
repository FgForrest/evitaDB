...
3. zpracování obsahu WAL a vytvoření nové "verze" databáze
   ...
   - kompakce datových souborů, pokud je to nutné ([podrobněji popsáno zde](storage-model.md#uklízení-nepořádku))
