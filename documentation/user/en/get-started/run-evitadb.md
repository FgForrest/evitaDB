...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_db:2025.2.0'
```
</CodeTabsBlock>
</CodeTabs>
...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_external_api_grpc:2025.2.0'
```
</CodeTabsBlock>
</CodeTabs>
...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_external_api_graphql:2025.2.0'
```
</CodeTabsBlock>
</CodeTabs>
...
<CodeTabsBlock>
```Gradle
implementation 'io.evitadb:evita_external_api_rest:2025.2.0'
```
</CodeTabsBlock>
</CodeTabs>
...
beta build 2025.2.0 (keep calm and report bugs 😉)
