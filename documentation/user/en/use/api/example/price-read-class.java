...
public class MyEntity {
	...
	public MyEntity(
		PriceContract priceForSale,
		PriceContract[] allPricesAvailableForSale,
		PriceContract basicPrice,
		Collection<PriceContract> allPrices, List<PriceContract> allPricesAsList,
		Set<PriceContract> allPricesAsSet, PriceContract[] allPricesAsArray
	) {
		this.priceForSale = priceForSale;
		this.allPricesAvailableForSale = allPricesAvailableForSale;
		this.basicPrice = basicPrice;
		this.allPrices = allPrices;
		this.allPricesAsList = allPricesAsList;
		this.allPricesAsSet = allPricesAsSet;
		this.allPricesAsArray = allPricesAsArray;
	}
}
