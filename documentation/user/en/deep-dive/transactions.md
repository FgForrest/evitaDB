...
The following conflict resolution policies are available:

1. Deny changes to the same entity part.
...
There are also special types of safe mutations that can help minimize conflict. One example is the "delta" attribute mutation, which can be applied safely in parallel.
