...
6. **PriceSuper.priceRecords (byte 26) — CORRECTED to a top lever for B2B (Johnny).** The gate catalog is
   ...
   (max 48K) badly under-represent a B2B catalog. Real B2B density (the price-dense B2B catalog): **7.6M prices / 130k products
   ≈ 58 prices/product**. Measured on the gate catalog: PriceSuper.priceRecords = **10.4 B/record**, and price
