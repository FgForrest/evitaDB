...
3. **Real embeddings from the senesi or decodoma catalog** supplied by Sage. **This is an assumption, not a
...
- **OP6-9 — real embeddings from Sage.** Can Sage today produce and export embeddings for senesi or decodoma?
