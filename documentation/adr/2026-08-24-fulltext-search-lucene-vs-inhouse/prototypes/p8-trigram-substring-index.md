...
- Measured scale on the senesi production catalog: **~179 000 reduced indexes** for one collection
...
prototype structures + JMH per §24/§27) on real corpora: the cnc production catalog (972K articles;
...
- **§19's "#545 shrinks V and with it K and E" has the emphasis backwards.** Case folding barely
  merges values (cnc V −0.5%, E −0.1%) — it collapses the *key space* (K −18.5% overall, −35.5% on
