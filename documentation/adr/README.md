...
|------|--------|------|--------|------|
| 2026-09-21 | [The reference-attribute cardinality counter keys on the index key, and a storage-protocol migration re-keys the counters already written](2026-09-21-cardinality-counter-normalized-keys.md) | fix | accepted | #1620 |
