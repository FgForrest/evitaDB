...
|------|--------|------|--------|------|
| 2026-09-13 | [Off-record number reads must not restore a buffer limit the read has invalidated](2026-09-13-off-record-reads-must-not-restore-an-invalidated-buffer-limit.md) | fix | accepted | #1551 |
