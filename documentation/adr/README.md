...
|------|--------|------|--------|------|
| 2026-09-15 | [Push release_* branches from CI as a GitHub App on the ruleset bypass list, not as GITHUB_TOKEN](2026-09-15-release-branch-pushes-as-a-github-app.md) | infrastructure | accepted | #1591, PR #1592 |
