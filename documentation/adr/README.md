...
| 2026-09-18 | [The range counting kernel drives its merge from chunk buckets, and a finished chunk crosses into the bitmap writer whole](2026-09-18-range-counting-kernel-per-operand-overhead.md) | optimization | proposed | #1604 |
