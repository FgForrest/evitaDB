...
|------|--------|------|--------|------|
| 2026-09-05 | [Fold duplicate content requirements once per request; refuse only the pairs that have no superset](2026-09-05-duplicate-content-requirements-reduction.md) | fix | accepted | #1493 |
