...
#   SOURCE_COMPRESS  reader reads compressed storage records      (default true; production exports are)
...
SOURCE_COMPRESS="${SOURCE_COMPRESS:-true}"
XMX="${XMX:-14g}"
XMS="${XMS:-8g}"
...
APP_PROPS=(
	...
	"-Devita.warmup.sourceCompress=${SOURCE_COMPRESS}"
)
