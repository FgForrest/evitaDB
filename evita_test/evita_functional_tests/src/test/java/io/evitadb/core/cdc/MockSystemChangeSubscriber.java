 ...
 */
class MockSystemChangeSubscriber implements Subscriber<ChangeSystemCapture>, AutoCloseable {
	/**
	...
	/**
	 * Creates a new MockSystemChangeSubscriber that never completes.
	 */
	...
	/**
	 * Creates a new MockSystemChangeSubscriber that will complete after receiving the specified number of items.
	 *
