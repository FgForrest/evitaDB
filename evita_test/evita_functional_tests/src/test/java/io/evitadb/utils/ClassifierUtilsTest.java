...
class ClassifierUtilsTest {
	...
	class FormatValidationTests {
		...
		@Test
		@DisplayName("Should refuse national characters")
		...
		@Test
		@DisplayName("Should have valid classifier format")
		...
		@Test
		@DisplayName("Should not have valid classifier format")
	...
	class KeywordTests {
		...
		@Test
		@DisplayName("Should not accept keywords")
