...
class TransactionalIntBPlusTreeTest {
	...
	class StmInvariantsTest {
		...
		void shouldReturnStableAndUniqueId() {
			final TransactionalIntBPlusTree<String> tree1 =
				new TransactionalIntBPlusTree<>(3, String.class);
			final TransactionalIntBPlusTree<String> tree2 =
				new TransactionalIntBPlusTree<>(3, String.class);
	...
	class ExtendedConstructorValidationTest {
		...
		void shouldRejectMinValueBlockSizeLessThanOne() {
			assertThrows(
				...
				() -> new TransactionalIntBPlusTree<>(3, 0, 3, 1, String.class)
			);
		}
		...
		void shouldRejectMinValueBlockSizeTooLarge() {
			...
			assertThrows(
				GenericEvitaInternalError.class,
				() -> new TransactionalIntBPlusTree<>(3, 2, 3, 1, String.class)
			);
		}
		...
		void shouldRejectMinInternalNodeBlockSizeLessThanOne() {
			assertThrows(
				GenericEvitaInternalError.class,
				() -> new TransactionalIntBPlusTree<>(3, 1, 3, 0, String.class)
			);
		}
		...
		void shouldRejectMinInternalNodeBlockSizeTooLarge() {
			...
			assertThrows(
				GenericEvitaInternalError.class,
				() -> new TransactionalIntBPlusTree<>(3, 1, 3, 2, String.class)
			);
		}
		...
		void shouldRejectInternalNodeBlockSizeLessThanThree() {
			assertThrows(
				GenericEvitaInternalError.class,
				() -> new TransactionalIntBPlusTree<>(3, 1, 1, 0, String.class)
			);
		}
		...
		void shouldRejectTransactionalValueTypeWithoutWrapper() {
			assertThrows(
				GenericEvitaInternalError.class,
				() -> new TransactionalIntBPlusTree<>(3, 1, 3, 1, TransactionalList.genericClass())
			);
		}
		...
		void shouldSetDefaultBlockSizesWithWrapperConstructor() {
			//noinspection unchecked
			final TransactionalIntBPlusTree<TransactionalList<String>> tree =
				new TransactionalIntBPlusTree<>(
					TransactionalList.genericClass(),
					list -> new TransactionalList<>((List<String>) list)
				);
