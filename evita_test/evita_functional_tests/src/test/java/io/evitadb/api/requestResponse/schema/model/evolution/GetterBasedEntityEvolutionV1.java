...
/**
 * Base V1 interface for schema evolution tests.
...
public interface GetterBasedEntityEvolutionV1 {

	String ENTITY_NAME = "GetterBasedEntityEvolution";
	...
	/**
	 * Reference target interface with one attribute.
	 */
