 ...
 */
@DisplayName("SetAssociatedDataSchemaLocalizedMutation")
class SetAssociatedDataSchemaLocalizedMutationTest {
	...
	class CombineWith {
		...
		@Test
		@DisplayName("should override localized flag of previous mutation when names match")
		void shouldOverrideLocalizedOfPreviousMutationIfNamesMatch() {
			final SetAssociatedDataSchemaLocalizedMutation mutation = new SetAssociatedDataSchemaLocalizedMutation(
				ASSOCIATED_DATA_NAME, true
			);
			final SetAssociatedDataSchemaLocalizedMutation existingMutation =
				new SetAssociatedDataSchemaLocalizedMutation(ASSOCIATED_DATA_NAME, false);
		...
		void shouldLeaveBothMutationsIfTheNameOfNewMutationDoesntMatch() {
			...
			final SetAssociatedDataSchemaLocalizedMutation existingMutation =
				new SetAssociatedDataSchemaLocalizedMutation("differentName", false);
	...
	class MutateSchema {
		...
		@Test
		@DisplayName("should set localized flag on associated data schema")
		...
		@Test
		@DisplayName("should return schema with same values when localized flag is unchanged")
		void shouldReturnSchemaWithSameValuesWhenLocalizedIsUnchanged() {
			final SetAssociatedDataSchemaLocalizedMutation mutation = new SetAssociatedDataSchemaLocalizedMutation(
				ASSOCIATED_DATA_NAME, false
			);
			// existing schema has localized=false
			final AssociatedDataSchemaContract mutatedSchema = mutation.mutate(createExistingAssociatedDataSchema());
			assertNotNull(mutatedSchema);
			assertFalse(mutatedSchema.isLocalized());
		}
	}
	...
	class MutateEntitySchema {
		...
		@Test
		@DisplayName("should update localized flag in entity schema")
	...
	class ContractMethods {
		...
		void shouldBeEqualToMutationWithSameParameters() {
			final SetAssociatedDataSchemaLocalizedMutation mutation1 = new SetAssociatedDataSchemaLocalizedMutation(
				ASSOCIATED_DATA_NAME, true
			);
			final SetAssociatedDataSchemaLocalizedMutation mutation2 = new SetAssociatedDataSchemaLocalizedMutation(
				ASSOCIATED_DATA_NAME, true
			);
		...
		@Test
		@DisplayName("should not be equal to mutation with different localized flag")
