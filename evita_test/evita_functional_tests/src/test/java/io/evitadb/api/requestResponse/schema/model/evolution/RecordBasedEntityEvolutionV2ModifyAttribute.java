...
/**
 * V2 evolution: modifies 'code' attribute to be filterable.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2026
 */
@Entity(name = RecordBasedEntityEvolutionV1.ENTITY_NAME)
public record RecordBasedEntityEvolutionV2ModifyAttribute(
	@PrimaryKey int id,
	@Attribute(filterable = true) @Nonnull String code,
