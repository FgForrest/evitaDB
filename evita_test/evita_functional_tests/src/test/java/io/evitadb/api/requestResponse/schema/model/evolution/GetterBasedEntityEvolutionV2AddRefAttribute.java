 ...
 * Cannot use inheritance since nested interface differs.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2026
 */
public interface GetterBasedEntityEvolutionV2AddRefAttribute extends GetterBasedEntityEvolutionV1 {

	@ReferenceRef("marketingBrand")
	@Override
	ExtendedBrand getMarketingBrand();

	interface ExtendedBrand extends GetterBasedEntityEvolutionV1.Brand {
