 ...
 */
@DisplayName("Evita referenced entity ordering by partitioned reference attribute functionality")
@IsolateDataSetBySuffix("filteringAndPartitioning")
@Tag(FUNCTIONAL_TEST)
@ExtendWith(EvitaParameterResolver.class)
@Slf4j
public class EntityByReferenceAttributeOrderingPartitionedFunctionalTest extends AbstractEntityByReferenceAttributeOrderingFunctionalTest {
