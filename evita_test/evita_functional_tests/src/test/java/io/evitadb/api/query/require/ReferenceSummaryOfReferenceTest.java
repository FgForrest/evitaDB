...
/**
 * Tests for {@link ReferenceSummaryOfReference} verifying construction, applicability, getters,
 * copy/clone operations, visitor acceptance, and equality contract.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@DisplayName("ReferenceSummaryOfReference constraint")
class ReferenceSummaryOfReferenceTest {
	...
	class ConstructionTest {
		...
		void shouldCreateWithReferenceNameOnly() {
			final ReferenceSummaryOfReference constraint = referenceSummaryOfReference("parameter");

			assertEquals(new ReferenceSummaryOfReference("parameter"), constraint);
		...
		void shouldCreateViaFactoryWithDepthAndRequirements() {
			final ReferenceSummaryOfReference constraint = referenceSummaryOfReference(
		...
		void shouldCreateFromRequirements() {
			assertEquals(
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.COUNTS),
				new ReferenceSummaryOfReference("parameter", FacetStatisticsDepth.COUNTS)
			);
			assertEquals(
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.COUNTS, entityFetch(attributeContent("code"))),
				new ReferenceSummaryOfReference(
	...
	class GetterTest {
		...
		void shouldReturnReferenceEntityRequirement() {
			assertEquals(
				entityFetch(attributeContent("code")),
				referenceSummaryOfReference("param", FacetStatisticsDepth.IMPACT, entityFetch(attributeContent("code")))
					.getReferenceEntityRequirement().orElse(null)
			);
			assertNull(
				referenceSummaryOfReference("param", FacetStatisticsDepth.IMPACT,
					entityGroupFetch(attributeContent("name")))
					.getReferenceEntityRequirement().orElse(null)
			);
			assertNull(
		...
		void shouldReturnFilterBy() {
			...
			assertNull(
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT).getFilterBy().orElse(null)
			);
		}
		...
		void shouldReturnFilterGroupBy() {
			...
			assertNull(
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT).getFilterGroupBy().orElse(null)
			);
		}
		...
		void shouldReturnOrderBy() {
			...
			assertNull(
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT).getOrderBy().orElse(null)
			);
		}
		...
		void shouldReturnOrderGroupBy() {
			...
			assertNull(
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT).getOrderGroupBy().orElse(null)
			);
		}
	}
	...
	class ApplicabilityTest {
		...
		void shouldBeApplicableWithReferenceName() {
			assertTrue(referenceSummaryOfReference("parameter").isApplicable());
			assertTrue(
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT,
	...
	class TypeAndVisitorTest {
		...
		void shouldReturnRequireConstraintClassAsType() {
			assertEquals(RequireConstraint.class, referenceSummaryOfReference("parameter").getType());
		}

		@Test
		@DisplayName("should accept visitor")
		void shouldAcceptVisitor() {
			final ReferenceSummaryOfReference constraint = referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT);
	...
	class CopyAndCloneTest {
		...
		void shouldCreateCopyWithNewChildren() {
			final ReferenceSummaryOfReference original = referenceSummaryOfReference(
				"parameter", FacetStatisticsDepth.IMPACT,
				filterBy(entityPrimaryKeyInSet(1)),
				filterGroupBy(entityPrimaryKeyInSet(2)),
				orderBy(attributeNatural("code", OrderDirection.ASC)),
			...
			assertInstanceOf(ReferenceSummaryOfReference.class, copy);
			final ReferenceSummaryOfReference copyRef = (ReferenceSummaryOfReference) copy;
		...
		void shouldCloneWithNewArguments() {
			...
			assertInstanceOf(ReferenceSummaryOfReference.class, cloned);
			assertEquals("other", ((ReferenceSummaryOfReference) cloned).getReferenceName());
			assertEquals(FacetStatisticsDepth.IMPACT, ((ReferenceSummaryOfReference) cloned).getStatisticsDepth());
			assertTrue(((ReferenceSummaryOfReference) cloned).getReferenceEntityRequirement().isPresent());
		}
	}
	...
	class ToStringTest {
		...
		void shouldProduceToStringWithNameOnly() {
			assertEquals(
				"referenceSummaryOfReference('parameter')",
				referenceSummaryOfReference("parameter").toString()
			);
		}
		...
		void shouldProduceToStringWithImpact() {
			assertEquals(
				"referenceSummaryOfReference('parameter',IMPACT,entityFetch())",
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT, entityFetch()).toString()
			);
			assertEquals(
				"referenceSummaryOfReference('parameter',IMPACT,entityFetch(attributeContent('code')),entityGroupFetch())",
				referenceSummaryOfReference(
					"parameter", FacetStatisticsDepth.IMPACT,
					entityFetch(attributeContent("code")), entityGroupFetch()
				).toString()
		...
		void shouldProduceToStringWithFilterAndOrder() {
			assertEquals(
				"referenceSummaryOfReference('parameter',filterBy(entityPrimaryKeyInSet(1)),"
	...
	class EqualityTest {
		...
		void shouldConformToEqualsAndHashContract() {
			assertNotSame(referenceSummaryOfReference("parameter"), referenceSummaryOfReference("parameter"));
			assertEquals(referenceSummaryOfReference("parameter"), referenceSummaryOfReference("parameter"));
			assertNotEquals(
				referenceSummaryOfReference("parameter"),
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT)
			);
			...
			assertNotEquals(
				...
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT, entityFetch(attributeContentAll()))
			);
		}
		...
		void shouldConformToHashCodeContract() {
			assertEquals(
				referenceSummaryOfReference("parameter").hashCode(),
				referenceSummaryOfReference("parameter").hashCode()
			);
			assertNotEquals(
				referenceSummaryOfReference(
				...
				referenceSummaryOfReference("parameter", FacetStatisticsDepth.IMPACT, entityFetch(attributeContent()))
					.hashCode()
			);
		}
	}
