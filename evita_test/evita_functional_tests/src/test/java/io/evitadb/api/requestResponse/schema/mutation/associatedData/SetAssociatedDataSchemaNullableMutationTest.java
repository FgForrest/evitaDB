 ...
 */
@DisplayName("SetAssociatedDataSchemaNullableMutation")
class SetAssociatedDataSchemaNullableMutationTest {
	...
	class CombineWith {
		...
		@Test
		@DisplayName("should override nullable flag of previous mutation when names match")
		void shouldOverrideNullableOfPreviousMutationIfNamesMatch() {
			final SetAssociatedDataSchemaNullableMutation mutation = new SetAssociatedDataSchemaNullableMutation(
				ASSOCIATED_DATA_NAME, true
			);
			final SetAssociatedDataSchemaNullableMutation existingMutation =
				new SetAssociatedDataSchemaNullableMutation(ASSOCIATED_DATA_NAME, false);
		...
		void shouldLeaveBothMutationsIfTheNameOfNewMutationDoesntMatch() {
			...
			final SetAssociatedDataSchemaNullableMutation existingMutation =
				new SetAssociatedDataSchemaNullableMutation("differentName", false);
	...
	class MutateSchema {
		...
		@Test
		@DisplayName("should set nullable flag on associated data schema")
		...
		@Test
		@DisplayName("should return schema with same values when nullable flag is unchanged")
		void shouldReturnSchemaWithSameValuesWhenNullableIsUnchanged() {
			final SetAssociatedDataSchemaNullableMutation mutation = new SetAssociatedDataSchemaNullableMutation(
				ASSOCIATED_DATA_NAME, false
			);
			// existing schema has nullable=false
			final AssociatedDataSchemaContract mutatedSchema = mutation.mutate(createExistingAssociatedDataSchema());
			assertNotNull(mutatedSchema);
			assertFalse(mutatedSchema.isNullable());
		}
	}
	...
	class MutateEntitySchema {
		...
		@Test
		@DisplayName("should update nullable flag in entity schema")
	...
	class ContractMethods {
		...
		@Test
		@DisplayName("should not be equal to mutation with different nullable flag")
