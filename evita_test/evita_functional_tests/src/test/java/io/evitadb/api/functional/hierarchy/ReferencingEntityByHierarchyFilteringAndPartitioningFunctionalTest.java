 ...
 * This test verifies correct behavior when the referenced entity is indexed for filtering and partitioning.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@DisplayName("Evita referenced entity filtering and partitioning by hierarchy functionality")
@IsolateDataSetBySuffix("filteringAndPartitioning")
@Tag(FUNCTIONAL_TEST)
@ExtendWith(EvitaParameterResolver.class)
@Slf4j
public class ReferencingEntityByHierarchyFilteringAndPartitioningFunctionalTest extends AbstractReferencingEntityByHierarchyFunctionalTest {
