...
/**
 * Generational randomized proof test for {@link ObjectBPlusTree}.
 *
 * @author Jan Novotny (novotny@fg.cz), FG Forrest a.s. (c) 2024
 */
@DisplayName("Object B+ tree (generational proof)")
@Tag(CONTRACT)
@Tag(DATA_TYPE)
class LongRunningObjectBPlusTreeTest implements TimeBoundedTestSupport {
	...
	private static void verifyTreeConsistency(
		@Nonnull ObjectBPlusTree<Integer, String> bPlusTree, @Nonnull Integer... expectedArray
	) {
	...
	private static void verifyForwardValueIterator(
		@Nonnull ObjectBPlusTree<Integer, String> tree, @Nonnull Integer... keyArray
	) {
