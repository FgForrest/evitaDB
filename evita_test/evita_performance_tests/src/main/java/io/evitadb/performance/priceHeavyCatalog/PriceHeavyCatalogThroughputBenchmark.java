...
/**
 * This class runs all tests in {@link PriceHeavyCatalogBenchmark} in throughput mode measurement.
 *
...
public class PriceHeavyCatalogThroughputBenchmark extends PriceHeavyCatalogBenchmark {
