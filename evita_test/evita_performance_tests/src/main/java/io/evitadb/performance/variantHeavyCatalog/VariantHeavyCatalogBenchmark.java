...
/**
 * This benchmark contains tests that use real anonymized data from a production B2C e-commerce catalog for
 * performance measurements. It holds ~15,700 products with 35 attributes and 7 references per entity, and is
 * dominated by master/variant combinations - around 1,500 master products with 8 variants each, so a master
 * selling price is computed from roughly 64 prices. It exercises the variant-heavy end of the workload range.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public abstract class VariantHeavyCatalogBenchmark {
	...
	*/
	...
	/**
	 * This test spins an empty DB inserts there full contents of the VariantHeavyCatalog database, switches it to the transactional
	...
	/**
	 * This test spins an empty DB inserts there full contents of the VariantHeavyCatalog database, switches it to the transactional mode
	...
	/**
	 * This test spins an empty DB inserts there full contents of the VariantHeavyCatalog database, switches it to the
