...
/**
 * This benchmark contains tests that use real anonymized data from a production e-commerce catalog for
 * performance measurements. It is the smallest corpus in the suite: ~13,000 products with a single price
 * each, 20 attributes and 4 references per entity, and effectively no master/variant products or product
 * sets. It exercises the simple, single-price end of the workload range.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public abstract class SinglePriceCatalogBenchmark {
	...
	*/
	...
	/**
	 * This test spins an empty DB inserts there full contents of the SinglePriceCatalog database, switches it to the transactional
	...
	/**
	 * This test spins an empty DB inserts there full contents of the SinglePriceCatalog database, switches it to the transactional mode
	...
	/**
	 * This test spins an empty DB inserts there full contents of the SinglePriceCatalog database, switches it to the
