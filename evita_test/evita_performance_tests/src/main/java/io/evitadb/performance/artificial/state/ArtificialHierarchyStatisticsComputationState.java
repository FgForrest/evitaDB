...
/**
 * Base state class for {@link ArtificialEntitiesBenchmark#hierarchyStatisticsComputation(ArtificialHierarchyBenchmarkState, ArtificialHierarchyStatisticsComputationState, Blackhole)}.
