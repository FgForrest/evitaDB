...
/**
 * This class runs all tests in {@link SinglePriceCatalogBenchmark} in throughput mode measurement.
 *
...
public class SinglePriceCatalogThroughputBenchmark extends SinglePriceCatalogBenchmark {
