...
/**
 * This class runs all tests in {@link VariantHeavyCatalogBenchmark} in throughput mode measurement.
 *
...
public class VariantHeavyCatalogThroughputBenchmark extends VariantHeavyCatalogBenchmark {
